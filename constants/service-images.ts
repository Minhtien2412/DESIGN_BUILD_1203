...
export const SERVICE_IMAGE_MAP = {
  'khoan-ep-coc': require('../assets/images/react-logo.png'),
  'giam-sat-thi-cong': require('../assets/images/react-logo.png'),
  'van-chuyen-xay-dung': require('../assets/images/react-logo.png'),
  'son-sua': require('../assets/images/react-logo.png'),
  'lap-kinh-inox': require('../assets/images/react-logo.png'),
  'lap-camera': require('../assets/images/react-logo.png'),
  'lap-cua': require('../assets/images/react-logo.png'),
  'han-co-khi': require('../assets/images/react-logo.png'),
  'mai-kim-loai': require('../assets/images/react-logo.png'),
  'op-lat-gach': require('../assets/images/react-logo.png'),
  'lat-gach': require('../assets/images/react-logo.png'),
  'sua-chua-dien-nuoc': require('../assets/images/react-logo.png'),
  'lap-khoa': require('../assets/images/react-logo.png'),
  'tran-thach-cao': require('../assets/images/react-logo.png'),
  'xay-to-tuong': require('../assets/images/react-logo.png'),
  'kho-vlxd': require('../assets/images/react-logo.png'),
  'do-be-tong': require('../assets/images/react-logo.png'),
  'dao-mong': require('../assets/images/react-logo.png'),
  'buoc-thep': require('../assets/images/react-logo.png'),
  'coffa': require('../assets/images/react-logo.png'),
  'trat-tuong': require('../assets/images/react-logo.png'),
  'lap-da': require('../assets/images/react-logo.png'),
} as const;
