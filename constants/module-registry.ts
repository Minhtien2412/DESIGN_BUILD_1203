...
export const CATEGORY_META: Record<ModuleCategory, { name: string; nameVi: string; icon: keyof typeof Ionicons.glyphMap; color: string }> = {
  ...
  shopping: { name: 'Shopping', nameVi: 'Mua sắm', icon: 'cart-outline', color: '#0D9488' },
  services: { name: 'Services', nameVi: 'Dịch vụ', icon: 'briefcase-outline', color: '#14B8A6' },
  projects: { name: 'Projects', nameVi: 'Dự án', icon: 'folder-outline', color: '#0D9488' },
  ...
  analytics: { name: 'Analytics', nameVi: 'Phân tích', icon: 'bar-chart-outline', color: '#0D9488' },
  tools: { name: 'Tools', nameVi: 'Công cụ', icon: 'hammer-outline', color: '#0D9488' },
  settings: { name: 'Settings', nameVi: 'Cài đặt', icon: 'settings-outline', color: '#666666' },
};
