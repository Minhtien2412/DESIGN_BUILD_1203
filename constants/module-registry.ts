...
export const CATEGORY_META: Record<ModuleCategory, { name: string; nameVi: string; icon: keyof typeof Ionicons.glyphMap; color: string }> = {
  ...
  shopping: { name: 'Shopping', nameVi: 'Mua sắm', icon: 'cart-outline', color: '#0066CC' },
  services: { name: 'Services', nameVi: 'Dịch vụ', icon: 'briefcase-outline', color: '#0080FF' },
  projects: { name: 'Projects', nameVi: 'Dự án', icon: 'folder-outline', color: '#0066CC' },
  ...
  analytics: { name: 'Analytics', nameVi: 'Phân tích', icon: 'bar-chart-outline', color: '#0066CC' },
  tools: { name: 'Tools', nameVi: 'Công cụ', icon: 'hammer-outline', color: '#0066CC' },
