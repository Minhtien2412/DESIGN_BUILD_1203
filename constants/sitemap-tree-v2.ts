...
const MAIN_ROUTES: SitemapNode = {
  ...
  children: [
    ...
    },
    {
      ...
      titleVi: "Trang chủ xây dựng",
      route: "/(tabs)/home-construction",
...
const CONSTRUCTION_ROUTES: SitemapNode = {
  ...
  children: [
    ...
    {
      id: "construction-progress-board",
      title: "Progress Board",
      titleVi: "Bảng tiến độ",
    ...
    {
      id: "villa-progress",
      title: "Villa Progress",
      titleVi: "Tiến độ biệt thự",
...
const PROJECTS_ROUTES: SitemapNode = {
  ...
  children: [
    ...
    },
    {
      ...
      titleVi: "Dự án khách hàng",
      route: "/projects/management/customer-projects",
      icon: "people-outline",
      roles: ["employee"],
    },
    {
      ...
      titleVi: "Tìm nhà thầu",
      route: "/projects/management/find-contractors",
      icon: "search-outline",
      roles: ["user"],
    },
    {
      id: "quotation-list",
      title: "Quotations",
      titleVi: "Danh sách báo giá",
      route: "/projects/management/quotation-list",
      icon: "document-text-outline",
      roles: ["user"],
    },
    // Architecture
    ...
    },
    {
      id: "create-phase",
      title: "Create Phase",
      titleVi: "Tạo giai đoạn",
      route: "/timeline/create-phase",
      icon: "add-outline",
      roles: ["user"],
    },
    {
      id: "create-task",
      title: "Create Task",
      titleVi: "Tạo công việc",
      route: "/timeline/create-task",
...
const COMMUNICATION_ROUTES: SitemapNode = {
  ...
  children: [
    ...
    },
    {
      ...
      titleVi: "Tin nhắn hợp nhất",
      route: "/messages/unified",
    ...
    },
    {
      ...
      titleVi: "Cuộc trò chuyện mới",
      route: "/messages/new-conversation",
      icon: "add-circle-outline",
      roles: ["user"],
    },
    {
    ...
    },
    {
      id: "realtime-chat",
      title: "Realtime Chat",
      titleVi: "Chat trực tuyến",
      route: "/messages/realtime-chat",
    ...
    {
      id: "communications-index",
      title: "Communications",
      titleVi: "Thông tin liên lạc",
...
const SERVICES_ROUTES: SitemapNode = {
  ...
  children: [
    ...
    },
    {
      ...
      titleVi: "Máy tính thiết kế",
      route: "/services/design-calculator",
      icon: "calculator-outline",
      roles: ["user"],
    },
    {
      id: "construction-lookup",
      title: "Construction Lookup",
      titleVi: "Tra cứu xây dựng",
    ...
    },
    {
      id: "color-trends",
      title: "Color Trends",
      titleVi: "Xu hướng màu",
      route: "/services/color-trends",
      icon: "trending-up-outline",
      roles: ["user"],
    },
    {
    ...
    // AI Services
    {
      ...
      children: [
        ...
        },
        {
          ...
          titleVi: "Phân tích ảnh",
          route: "/ai/photo-analysis",
          icon: "camera-outline",
          roles: ["user"],
        },
        {
          id: "ai-material-check",
          title: "Material Check",
          titleVi: "Kiểm tra vật liệu",
...
const UTILITIES_ROUTES: SitemapNode = {
  ...
  children: [
    ...
    },
    {
      ...
      titleVi: "Chẩn đoán API",
      route: "/utilities/api-diagnostics",
      icon: "bug-outline",
      roles: ["admin"],
    },
    {
      ...
      titleVi: "Chẩn đoán mạng",
      route: "/utilities/network-diagnostics",
      icon: "wifi-outline",
      roles: ["admin"],
    },
    // Workforce
    ...
    // Construction Materials
    {
      ...
      children: [
        ...
        {
          id: "construction-util",
          title: "Construction",
          titleVi: "Xây dựng",
          route: "/utilities/construction",
          icon: "construct-outline",
          roles: ["user"],
        },
      ],
    ...
    // Seller
    {
      ...
      children: [
        ...
        },
        {
          id: "edit-product",
          title: "Edit Product",
          titleVi: "Sửa sản phẩm",
          route: "/seller/edit-product",
          icon: "create-outline",
          roles: ["user"],
        },
      ],
...
const PROFILE_ROUTES: SitemapNode = {
  ...
  children: [
    ...
    },
    {
      ...
      titleVi: "Hồ sơ nâng cao",
      route: "/profile/enhanced",
      icon: "star-outline",
      roles: ["user"],
    },
    {
    ...
    },
    {
      id: "profile-cloud",
      title: "Cloud Storage",
      titleVi: "Lưu trữ đám mây",
      route: "/settings/data/cloud",
      icon: "cloud-outline",
      roles: ["user"],
    },
    {
    ...
    {
      id: "profile-my-products",
      title: "My Products",
      titleVi: "Sản phẩm của tôi",
...
export const getPersonalTimelineRoutes = (
  sitemap: SitemapNode,
): SitemapNode[] => {
  return flattenSitemap(sitemap).filter(
    (node) => node.isPersonalTimeline && node.route,
  );
};

export const getDashboardRoutes = (sitemap: SitemapNode): SitemapNode[] => {
  return flattenSitemap(sitemap).filter(
    (node) => node.isDashboardItem && node.route,
  );
};

export const searchSitemapRoutes = (
  keyword: string,
  sitemap: SitemapNode,
): SitemapNode[] => {
