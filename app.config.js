...
const ENV_API_BASE =
  process.env.EXPO_PUBLIC_API_BASE_URL || (IS_DEV ? DEV_API_URL : PROD_API_URL);
    ...
    ios: {
      ...
      infoPlist: {
        ...
        NSMicrophoneUsageDescription:
          "Ứng dụng cần quyền micro để ghi âm khi quay video.",
        NSPhotoLibraryUsageDescription:
          "Ứng dụng cần quyền truy cập thư viện ảnh để chọn ảnh và video.",
