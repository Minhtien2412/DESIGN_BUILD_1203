...
export function getStatusColor(type: 'project' | 'invoice' | 'task' | 'lead', status: string): string {
  const colors: Record<string, Record<string, string>> = {
    project: { '1': '#6B7280', '2': '#0D9488', '3': '#0D9488', '4': '#0D9488', '5': '#000000' },
    invoice: { '1': '#0D9488', '2': '#0D9488', '3': '#0D9488', '4': '#000000', '5': '#6B7280', '6': '#000000' },
    task: { '1': '#6B7280', '2': '#0D9488', '3': '#666666', '4': '#0D9488', '5': '#0D9488' },
    lead: { '1': '#0D9488', '2': '#0D9488', '3': '#666666', '4': '#0D9488', '5': '#000000' },
  };
