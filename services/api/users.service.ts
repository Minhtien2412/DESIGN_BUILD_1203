...
const MOCK_USERS_DB: UserProfile[] = [
  ...
  // ======= Design Build Team (community feed author) =======
  {
    id: "design-build-team",
    email: "team@designbuild.vn",
    name: "Design Build Team",
    phone: "1900 8686",
    role: "ADMIN",
    verified: true,
    avatar: "https://ui-avatars.com/api/?name=DB&background=6366f1&color=fff",
    bio: "Đội ngũ chuyên gia Design Build - Thiết kế và Thi công trọn gói biệt thự, resort, nội thất cao cấp. Chia sẻ kiến thức xây dựng, video tiến độ và tư vấn miễn phí.",
    company: "Design Build Platform",
    businessType: "company",
    position: "Official Team",
    rating: 4.9,
    reviewCount: 1250,
    projectsCount: 200,
    yearsExperience: 15,
    ...
    certifications: [
      "ISO 9001:2015",
      "Giấy phép xây dựng hạng 1",
      "Chứng nhận thiết kế quốc tế",
    ],
    identityVerified: true,
    emailVerified: true,
    phoneVerified: true,
    website: "https://designbuild.vn",
