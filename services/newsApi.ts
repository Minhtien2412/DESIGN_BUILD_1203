 ...
 * Ưu tiên: NewsAPI → GNews → TheNewsAPI → MediaStack
 * 
...
async function fetchNewsAPI(query: NewsQuery): Promise<NewsResponse | null> {
  ...
  try {
    ...
    if (query.q) {
      ...
      if (query.category && query.category !== 'construction' && query.category !== 'realestate') {
...
export async function getNews(query: NewsQuery = {}): Promise<NewsResponse> {
  ...
  if (isServiceConfigured('newsapi')) {
 ...
 */
export async function getConstructionNews(pageSize = 10): Promise<NewsArticle[]> {
  ...
  const mockArticles: NewsArticle[] = [
    {
      ...
      description: 'Các chuyên gia dự đoán xu hướng thiết kế resort năm 2025 sẽ tập trung vào yếu tố bền vững, sử dụng vật liệu tái chế và hòa hợp với thiên nhiên.',
      content: 'Theo các chuyên gia trong ngành, xu hướng thiết kế resort 2025 sẽ đặc biệt chú trọng đến các yếu tố bền vững...',
    ...
    },
    {
      ...
      description: 'Bất động sản nghỉ dưỡng Việt Nam ghi nhận mức tăng trưởng 15% trong quý đầu năm, đặc biệt tại các thành phố biển.',
      content: 'Theo báo cáo mới nhất từ các đơn vị nghiên cứu thị trường, bất động sản nghỉ dưỡng Việt Nam...',
    ...
    },
    {
      ...
      description: 'Nhiều doanh nghiệp xây dựng đã áp dụng trí tuệ nhân tạo để tối ưu hóa quản lý dự án và giảm chi phí.',
      content: 'Trong bối cảnh chuyển đổi số, ngành xây dựng đang tích cực áp dụng công nghệ AI...',
    ...
    },
    {
      ...
      description: 'Phú Quốc tiếp tục khẳng định vị thế là điểm đến hàng đầu cho các dự án resort cao cấp tại Việt Nam.',
      content: 'Với lợi thế về vị trí địa lý và cảnh quan thiên nhiên, Phú Quốc đang thu hút nhiều nhà đầu tư...',
    ...
    },
    {
      ...
      description: 'Xu hướng sử dụng vật liệu xây dựng thân thiện với môi trường đang ngày càng phổ biến.',
      content: 'Các vật liệu xây dựng xanh như tre, gỗ tái chế, bê tông tái sinh đang được ưa chuộng...',
