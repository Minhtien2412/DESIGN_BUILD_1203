...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Products - synced with backend Prisma';
    displayName: 'Product';
    pluralName: 'products';
  ...
  attributes: {
    backendId: Schema.Attribute.Integer;
    ...
    stock: Schema.Attribute.Integer &
      ...
      > &
      Schema.Attribute.DefaultTo<0>;
    strapiId: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Construction projects - synced with backend Prisma';
    displayName: 'Project';
    pluralName: 'projects';
  ...
  attributes: {
    ...
    engineerId: Schema.Attribute.Integer;
    images: Schema.Attribute.Media<'images', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Construction services - synced with backend Prisma';
    displayName: 'Service';
    pluralName: 'services';
  ...
  attributes: {
    ...
    unit: Schema.Attribute.String &
      ...
      Schema.Attribute.DefaultTo<'c\u00F4ng tr\u00ECnh'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    viewCount: Schema.Attribute.Integer &
...
export interface ApiTaskTask extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Project tasks - synced with backend Prisma';
    displayName: 'Task';
    pluralName: 'tasks';
    singularName: 'task';
  };
  ...
  attributes: {
    ...
    projectId: Schema.Attribute.Integer & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    status: Schema.Attribute.Enumeration<
