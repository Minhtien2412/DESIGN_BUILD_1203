...
const createMockConversations = (
  ...
  const cskh: UnifiedConversation = {
    ...
    lastMessage: {
      ...
      type: "text",
      content:
        "Chào mừng bạn đến với Thiết Kế Resort! 🏠 Chúng tôi luôn sẵn sàng hỗ trợ bạn 24/7.",
  ...
  const conversations: Record<string, UnifiedMessage[]> = {
    ...
    conv_cskh: [
      ...
      },
      {
        ...
        type: "text",
        content:
          "Chúng tôi cung cấp dịch vụ thiết kế và thi công resort, villa, nhà ở cao cấp với đội ngũ kiến trúc sư và kỹ sư giàu kinh nghiệm.",
        deliveryStatus: "delivered",
        isRead: true,
      ...
      },
      {
        ...
        type: "text",
        content:
          "Chào mừng bạn đến với Thiết Kế Resort! 🏠 Chúng tôi luôn sẵn sàng hỗ trợ bạn 24/7. Bạn có thể nhắn tin hoặc gọi điện cho chúng tôi bất cứ lúc nào.",
        deliveryStatus: "delivered",
        isRead: false,
        createdAt: new Date().toISOString(),
        updatedAt: new Date().toISOString(),
    ...
    conv_2: [
      ...
      },
      {
        ...
        type: "text",
        content:
          "Chào anh Hoàng, dự án đang ở giai đoạn thiết kế chi tiết. Dự kiến tuần sau sẽ có bản hoàn chỉnh.",
        deliveryStatus: "read",
        isRead: true,
        createdAt: new Date(Date.now() - 4 * 3600000).toISOString(),
        updatedAt: new Date(Date.now() - 4 * 3600000).toISOString(),
...
export function useUnifiedMessaging(
  ...
  const [typingUsers, _setTypingUsers] = useState<User[]>([]);
  ...
  const getOrCreateConversation = useCallback(
    async (params: {
      ...
      const newUser: User = {
        ...
        avatar:
          params.userAvatar ||
          `https://i.pravatar.cc/150?u=company${params.userId}`,
