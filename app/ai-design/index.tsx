...
const generatedDesigns = [
  { id: '1', image: 'https://via.placeholder.com/400x300', style: 'Hiện đại', likes: 234 },
  { id: '2', image: 'https://via.placeholder.com/400x300', style: 'Tối giản', likes: 189 },
  { id: '3', image: 'https://via.placeholder.com/400x300', style: 'Scandinavian', likes: 156 },
];
    ...
    <View style={[styles.container, { backgroundColor }]}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={[styles.section, { backgroundColor: cardBg }]}>
          <Text style={[styles.sectionTitle, { color: textColor }]}>Chọn loại phòng</Text>
        ...
        {/* Style Selection */}
        <View style={[styles.section, { backgroundColor: cardBg }]}>
          <Text style={[styles.sectionTitle, { color: textColor }]}>Chọn phong cách</Text>
        ...
        {/* Prompt Input */}
        <View style={[styles.section, { backgroundColor: cardBg }]}>
          <Text style={[styles.sectionTitle, { color: textColor }]}>Mô tả thêm (tùy chọn)</Text>
          <TextInput
        ...
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            <Text style={[styles.sectionTitle, { color: textColor }]}>Thiết kế gần đây</Text>
            <TouchableOpacity>
        ...
        <View style={[styles.tipsCard, { backgroundColor: cardBg }]}>
          ...
          <View style={styles.tipsContent}>
            <Text style={[styles.tipsTitle, { color: textColor }]}>Mẹo tạo thiết kế đẹp</Text>
...
const styles = StyleSheet.create({
  ...
  heroSubtitle: { color: '#fff', opacity: 0.9, textAlign: 'center', marginTop: 8 },
  ...
  designsGrid: { flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'space-between' },
  designCard: { width: '48%', height: 150, borderRadius: 12, overflow: 'hidden', marginBottom: 12 },
