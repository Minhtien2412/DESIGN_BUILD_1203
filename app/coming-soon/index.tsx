...
const comingSoonFeatureKeys = [
  {
    id: "1",
    titleKey: "comingSoon.arRoom",
    descKey: "comingSoon.arRoomDesc",
    icon: "cube-outline",
    color: "#14B8A6",
    progress: 75,
  },
  {
    id: "2",
    titleKey: "comingSoon.vrTour",
    descKey: "comingSoon.vrTourDesc",
  ...
  {
    id: "3",
    titleKey: "comingSoon.aiDesign",
    descKey: "comingSoon.aiDesignDesc",
  ...
  {
    id: "4",
    titleKey: "comingSoon.marketplace",
    descKey: "comingSoon.marketplaceDesc",
    icon: "people-outline",
    color: "#9C27B0",
    progress: 90,
  },
  {
    id: "5",
    titleKey: "comingSoon.smartHome",
    descKey: "comingSoon.smartHomeDesc",
    icon: "home-outline",
    color: "#FF9800",
    progress: 40,
  },
  {
    id: "6",
    titleKey: "comingSoon.installment",
    descKey: "comingSoon.installmentDesc",
    icon: "card-outline",
    color: "#F44336",
    progress: 95,
  },
...
export default function ComingSoonScreen() {
  ...
  return (
    <View style={[styles.container, { backgroundColor }]}>
      <Stack.Screen
        options={{ title: t("comingSoon.title"), headerShown: true }}
      />
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.heroSection}>
          ...
          <Text style={styles.heroSubtitle}>{t("comingSoon.description")}</Text>
        </View>
            ...
            >
              ...
              <View style={styles.progressSection}>
                <View style={styles.progressHeader}>
                  ...
                  <Text
                    style={[styles.progressPercent, { color: feature.color }]}
                  >
                    {feature.progress}%
                  </Text>
                </View>
              ...
              <TouchableOpacity
                style={[styles.notifyBtn, { borderColor: feature.color }]}
              >
                <Ionicons
                  ...
                  color={feature.color}
                />
                <Text style={[styles.notifyBtnText, { color: feature.color }]}>
        ...
        <View style={[styles.newsletterCard, { backgroundColor: "#14B8A6" }]}>
          ...
          <Text style={styles.newsletterTitle}>
            {t("comingSoon.newsletter")}
          </Text>
          <Text style={styles.newsletterDesc}>
            {t("comingSoon.newsletterDesc")}
          </Text>
          <TouchableOpacity style={styles.subscribeBtn}>
            <Text style={styles.subscribeBtnText}>
              {t("comingSoon.subscribeNow")}
            </Text>
          </TouchableOpacity>
        </View>
          ...
          <View style={styles.feedbackContent}>
            ...
            <View style={styles.feedbackText}>
              <Text style={[styles.feedbackTitle, { color: textColor }]}>
                {t("comingSoon.ideaTitle")}
              </Text>
              <Text style={styles.feedbackDesc}>
                {t("comingSoon.ideaDesc")}
              </Text>
            </View>
          </View>
          <TouchableOpacity style={styles.feedbackBtn}>
            <Text style={styles.feedbackBtnText}>
              {t("comingSoon.feedback")}
            </Text>
          </TouchableOpacity>
        </View>
      </ScrollView>
