...
const CATEGORIES = [
  ...
  { id: "4", name: "Điện", icon: "flash-outline", color: "#0D9488" },
  { id: "5", name: "Nước", icon: "water-outline", color: "#0D9488" },
  { id: "6", name: "Sơn", icon: "color-palette-outline", color: "#999999" },
  { id: "7", name: "Cửa", icon: "lock-closed-outline", color: "#666666" },
  { id: "8", name: "Vệ sinh", icon: "medical-outline", color: "#0D9488" },
];
...
export default function MaterialsShoppingScreen() {
  ...
  const fetchSuppliers = useCallback(async () => {
    try {
      const res = await get("/api/materials/suppliers");
  ...
  const handleSupplierPress = (supplier: Supplier) => {
    router.push({
      pathname: "/materials/supplier/[id]",
