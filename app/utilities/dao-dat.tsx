...
const styles = StyleSheet.create({
  ...
  serviceTag: { backgroundColor: '#F0FDFA', paddingHorizontal: 10, paddingVertical: 4, borderRadius: 12 },
  serviceText: { fontSize: 11, fontWeight: '500', color: '#0D9488' },
  ...
  infoBanner: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#F0FDFA', paddingHorizontal: 16, paddingVertical: 10, gap: 8 },
