...
const featuredProducts = [
  { id: '1', name: 'Gạch Granite 60x60', price: 185000, originalPrice: 220000, rating: 4.8, sold: 2345, image: 'https://via.placeholder.com/150' },
  { id: '2', name: 'Sơn Dulux 5 in 1', price: 890000, originalPrice: 1050000, rating: 4.9, sold: 1234, image: 'https://via.placeholder.com/150' },
  { id: '3', name: 'Bồn cầu TOTO', price: 8500000, originalPrice: 9800000, rating: 4.9, sold: 567, image: 'https://via.placeholder.com/150' },
  { id: '4', name: 'Đèn LED panel', price: 450000, originalPrice: 550000, rating: 4.7, sold: 890, image: 'https://via.placeholder.com/150' },
];

const banners = [
  { id: '1', image: 'https://via.placeholder.com/350x150/FF6B35/fff?text=SALE+50%', title: 'Giảm đến 50%' },
  { id: '2', image: 'https://via.placeholder.com/350x150/4CAF50/fff?text=FREE+SHIP', title: 'Freeship mọi đơn' },
];
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={[styles.quickActions, { backgroundColor: cardBg }]}>
          <TouchableOpacity style={styles.quickAction}>
            <View style={[styles.quickActionIcon, { backgroundColor: '#FFE0E0' }]}>
              <Ionicons name="flash" size={20} color="#F44336" />
            </View>
            <Text style={[styles.quickActionText, { color: textColor }]}>Flash Sale</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.quickAction}>
            <View style={[styles.quickActionIcon, { backgroundColor: '#E3F2FD' }]}>
              <Ionicons name="ticket-outline" size={20} color="#2196F3" />
            </View>
            <Text style={[styles.quickActionText, { color: textColor }]}>Voucher</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.quickAction}>
            <View style={[styles.quickActionIcon, { backgroundColor: '#FFF3E0' }]}>
              <Ionicons name="gift-outline" size={20} color="#FF9800" />
            </View>
            <Text style={[styles.quickActionText, { color: textColor }]}>Ưu đãi</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.quickAction}>
            <View style={[styles.quickActionIcon, { backgroundColor: '#E8F5E9' }]}>
              <Ionicons name="ribbon-outline" size={20} color="#4CAF50" />
            </View>
            <Text style={[styles.quickActionText, { color: textColor }]}>Thương hiệu</Text>
          </TouchableOpacity>
        </View>

        {/* Categories */}
        <View style={[styles.section, { backgroundColor: cardBg }]}>
          <Text style={[styles.sectionTitle, { color: textColor }]}>Danh mục</Text>
          <View style={styles.categoriesGrid}>
            {categories.map((cat) => (
              <TouchableOpacity key={cat.id} style={styles.categoryItem}>
                ...
                {cat.count > 0 && <Text style={styles.categoryCount}>{cat.count}</Text>}
              </TouchableOpacity>
            ))}
          </View>
        </View>
        ...
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            <Text style={[styles.sectionTitle, { color: textColor }]}>🔥 Sản phẩm hot</Text>
            <TouchableOpacity>
          ...
          <View style={styles.productsGrid}>
            {featuredProducts.map((product) => (
              <TouchableOpacity key={product.id} style={[styles.productCard, { backgroundColor: cardBg }]}>
...
const styles = StyleSheet.create({
  container: { flex: 1 },
  searchHeader: { flexDirection: 'row', alignItems: 'center', padding: 12, paddingTop: 8 },
  searchBox: {
    flex: 1,
    flexDirection: 'row',
    alignItems: 'center',
  ...
  bannerItem: { width: width - 32, marginHorizontal: 16, borderRadius: 12, overflow: 'hidden' },
  bannerImage: { width: '100%', height: 120, backgroundColor: '#f0f0f0' },
  quickActions: { flexDirection: 'row', padding: 16, marginHorizontal: 16, borderRadius: 12 },
  ...
  categoryIcon: { width: 52, height: 52, borderRadius: 16, justifyContent: 'center', alignItems: 'center', marginBottom: 6 },
  categoryName: { fontSize: 11, textAlign: 'center' },
  categoryCount: { fontSize: 9, color: '#999', marginTop: 2 },
  productsGrid: { flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'space-between' },
  productCard: { width: '48%', borderRadius: 12, overflow: 'hidden', marginBottom: 12 },
  productImage: { width: '100%', height: 140, backgroundColor: '#f0f0f0' },
  productContent: { padding: 10 },
  productName: { fontSize: 13, height: 36 },
  productPrice: { color: '#FF6B35', fontSize: 15, fontWeight: 'bold', marginTop: 4 },
