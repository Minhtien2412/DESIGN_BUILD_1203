...
const helpCategories = [
  {
    ...
    icon: "person-outline",
    title: "Tài khoản",
    desc: "Đăng ký, đăng nhập, bảo mật",
  },
  {
    id: "2",
    icon: "cart-outline",
    title: "Đặt hàng",
    desc: "Cách đặt hàng, thanh toán",
  },
  {
    id: "3",
    icon: "car-outline",
    title: "Vận chuyển",
    desc: "Giao hàng, theo dõi đơn",
  },
  {
    id: "4",
  ...
  },
  {
    ...
    title: "Dự án",
    desc: "Quản lý dự án xây dựng",
  },
  {
    id: "6",
    icon: "people-outline",
    title: "Thợ & Dịch vụ",
    desc: "Thuê thợ, đánh giá",
  },
];
...
const faqs = [
  {
    ...
    a: "Chọn sản phẩm, thêm vào giỏ hàng và tiến hành thanh toán.",
  },
  {
    q: "Phí vận chuyển như thế nào?",
    a: "Miễn phí cho đơn hàng trên 500.000đ, các đơn khác tính theo khu vực.",
  },
  {
    q: "Tôi có thể hủy đơn không?",
    a: "Có, bạn có thể hủy đơn trước khi đơn được giao cho đơn vị vận chuyển.",
  },
  {
    q: "Làm sao liên hệ hỗ trợ?",
    a: "Gọi hotline 1900-xxxx hoặc chat trực tiếp trong app.",
  },
];
...
export default function HelpScreen() {
  ...
  return (
    <View style={[styles.container, { backgroundColor }]}>
      <Stack.Screen
        options={{ title: "Trung tâm trợ giúp", headerShown: true }}
      />
...
const styles = StyleSheet.create({
  ...
  quickBtnText: { color: "#fff", fontWeight: "700", fontSize: 15 },
  section: {
    margin: 16,
    marginTop: 0,
    padding: 16,
  ...
  categoryDesc: { fontSize: 12, color: "#6B7280", textAlign: "center" },
  faqItem: {
    borderBottomWidth: 1,
  ...
  faqAnswer: { color: "#6B7280", fontSize: 14, marginTop: 8, lineHeight: 20 },
