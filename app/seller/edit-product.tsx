/**
 * Edit Product Screen - Edit existing products/services
 * Màn hình chỉnh sửa sản phẩm/dịch vụ
 */
...
export default function EditProductScreen() {
  ...
  useEffect(() => {
    const loadProduct = async () => {
      try {
        ...
        setCategory(data.category || 'vat-lieu');
  ...
  const handleUpdate = async () => {
    ...
    try {
      ...
      Alert.alert('Lỗi', error.detail || 'Không thể cập nhật sản phẩm. Vui lòng thử lại.');
    } finally {
      setSubmitting(false);
    }
  };
  ...
  return (
    <ProtectedScreen requireAuth={true} requirePermissions={['product.edit_own']}>
