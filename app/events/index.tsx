...
const events = [
  {
    ...
    image: 'https://via.placeholder.com/400x200/FF6B35/fff?text=VIETBUILD',
    date: '15-18/01/2026',
  ...
  },
  {
    ...
    image: 'https://via.placeholder.com/400x200/4CAF50/fff?text=WORKSHOP',
    date: '20/01/2026',
    location: 'Online',
    category: 'Workshop',
    price: '500.000đ',
  ...
  },
  {
    ...
    image: 'https://via.placeholder.com/400x200/2196F3/fff?text=SEMINAR',
    date: '25/01/2026',
  ...
  },
  {
    ...
    image: 'https://via.placeholder.com/400x200/FF9800/fff?text=CLASS',
    date: '28-30/01/2026',
      ...
      <View style={styles.eventContent}>
        ...
        <View style={styles.eventFooter}>
          <View style={styles.priceBox}>
            <Text style={[styles.priceText, item.price === 'Miễn phí' && { color: '#4CAF50' }]}>
              {item.price}
            </Text>
          </View>
          <View style={styles.attendeesBox}>
            <Ionicons name="people-outline" size={14} color="#666" />
            <Text style={styles.attendeesText}>{formatAttendees(item.attendees)} người</Text>
          </View>
        </View>
...
const styles = StyleSheet.create({
  ...
  eventTitle: { fontSize: 16, fontWeight: '600', marginBottom: 12, lineHeight: 22 },
  eventInfo: { gap: 8, marginBottom: 12 },
  infoRow: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  infoText: { color: '#666', fontSize: 13, flex: 1 },
  eventFooter: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 },
  priceBox: {},
