    ...
    return (
      <SafeAreaView style={[styles.container, { backgroundColor }]}>
        ...
        >
          ...
          <Text style={{ color: "#EF4444", marginTop: 16, fontSize: 16 }}>
            Lỗi tải dữ liệu
          </Text>
              ...
              <>
                ...
                <View style={styles.profileSection}>
                  {selectedStaff.profile_image ? (
                    <Image
                      source={{ uri: selectedStaff.profile_image }}
                  ...
                  <View style={styles.profileBadges}>
                    <View
                      style={[
                        ...
                        {
                          backgroundColor:
                            getRoleColor(selectedStaff.role) + "20",
                        },
                      ]}
                    >
                      <Text
                    ...
                    <View
                      style={[
                        ...
                        {
                          backgroundColor:
                            getStatusColor(selectedStaff.active) + "20",
                        },
                      ]}
                    >
                      <Text
                        style={[
                          styles.statusText,
                          { color: getStatusColor(selectedStaff.active) },
                        ]}
                      >
                ...
                <View style={styles.statsSection}>
                  <Text
                    style={[styles.statsSectionTitle, { color: textColor }]}
                  >
                    Thông tin
                  </Text>
                  <View style={styles.statsGrid}>
                    ...
                    >
                      <Text
                        style={[styles.statsBoxValue, { color: "#22c55e" }]}
                      >
                        {selectedStaff.hourly_rate || "0"}đ
                      </Text>
                      <Text
                        style={[styles.statsBoxLabel, { color: textColor }]}
                      >
                        Lương/h
                      </Text>
                    </View>
