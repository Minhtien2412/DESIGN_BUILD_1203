...
function SettingsContent() {
  const { syncState, availableEndpoints, refreshAll, clearCache } =
    usePerfexFullSync();
  ...
  const testConnection = useCallback(async () => {
    ...
    try {
      ...
      if (response.ok) {
        Alert.alert(
          "✓ Kết nối thành công",
          "API Perfex CRM đang hoạt động bình thường.",
        );
      } else {
        Alert.alert(
          "✗ Lỗi kết nối",
          `Server trả về mã lỗi: ${response.status}`,
        );
      }
    } catch (error: any) {
  ...
  const openCrmInBrowser = () => {
    Linking.openURL(
      ENV.PERFEX_CRM_URL || "https://thietkeresort.com.vn/perfex_crm",
    );
  };
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.card}>
            ...
            <View style={styles.infoRow}>
              ...
              <Text style={styles.infoValue}>
                {ENV.PERFEX_API_TOKEN
                  ? "••••••••" + ENV.PERFEX_API_TOKEN.slice(-8)
                  : "Chưa cấu hình"}
              </Text>
            </View>
              ...
              <View style={styles.statusBadge}>
                <View
                  style={[
                    ...
                    {
                      backgroundColor:
                        availableEndpoints.length > 0 ? "#0D9488" : "#000000",
                    },
                  ]}
                />
                <Text
        ...
        <View style={styles.section}>
          ...
          <View style={styles.card}>
            <EndpointRow
              name="Customers"
              available={availableEndpoints.includes("customers") || true}
            />
            <EndpointRow
              name="Projects"
              available={availableEndpoints.includes("projects") || true}
            />
            <EndpointRow
              name="Staff"
          ...
          {availableEndpoints.length < 5 && (
            <View style={styles.upgradeCard}>
              <Ionicons name="rocket" size={24} color="#0D9488" />
              <View style={styles.upgradeContent}>
                <Text style={styles.upgradeTitle}>Mở khóa tất cả API</Text>
                <Text style={styles.upgradeText}>
                  Cài đặt module "mobile_api" vào Perfex CRM để có đầy đủ quyền
                  truy cập API: Staff, Invoices, Leads, Tasks...
                </Text>
              </View>
            </View>
          )}
          ...
          <View style={styles.card}>
            <View style={styles.settingRow}>
              ...
              <Switch
                ...
                thumbColor={autoSync ? "#0D9488" : "#9CA3AF"}
              />
            </View>
            ...
            <View style={styles.settingRow}>
              ...
              >
                {syncState.isSyncing ? (
                  ...
                  <Ionicons name="sync" size={20} color="#0D9488" />
                )}
              </TouchableOpacity>
            </View>
          </View>
          ...
          <View style={styles.card}>
            <View style={styles.cacheInfo}>
              ...
              <Text style={styles.cacheText}>
                Dữ liệu được lưu cache cục bộ để giảm tải server và tăng tốc độ
                truy cập.
              </Text>
            </View>
        ...
        <View style={styles.section}>
          ...
          <TouchableOpacity style={styles.linkCard} onPress={openCrmInBrowser}>
            <Ionicons name="open-outline" size={20} color="#0D9488" />
          ...
          <TouchableOpacity
            ...
            onPress={() =>
              Linking.openURL("https://thietkeresort.com.vn/perfex_crm/admin")
            }
          >
