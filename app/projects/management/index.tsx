    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.projectTitleCard}>
          ...
          <Text style={styles.projectTitle}>Biệt Thự Tân Cổ Điển KingCrown</Text>
        </View>
          ...
          <View style={styles.progressRow}>
            <View style={{ flex: 1 }}>
              <Text style={styles.progressCurrent}>
                ...
                <Text style={styles.progressCurrentName}>Công tác cột bê tông</Text>
              </Text>
            </View>
      ...
      <View style={[styles.bottomNav, { paddingBottom: insets.bottom }]}>
        ...
        <TouchableOpacity style={styles.navItem}>
          <MaterialIcons name="dashboard" size={20} color={MODERN_COLORS.gray900} />
          <Text style={styles.navLabel}>Tiện ích</Text>
        </TouchableOpacity>

        <TouchableOpacity style={styles.navItem} onPress={() => router.push('/notifications')}>
          <Ionicons name="notifications" size={20} color={MODERN_COLORS.gray900} />
        ...
        <TouchableOpacity style={styles.navItem} onPress={() => router.push('/profile')}>
          ...
          <Text style={[styles.navLabel, { color: '#0D9488' }]}>Trang cá nhân</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
