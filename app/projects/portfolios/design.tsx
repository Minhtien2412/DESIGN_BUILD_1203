...
const PORTFOLIO_ITEMS: PortfolioItem[] = [
  {
    ...
    route: '/projects/portfolio/schedule',
  },
  {
    id: '2',
    title: 'BOQ/Dự Toán Tóm Tắt',
    icon: 'calculator-outline',
    route: '/projects/portfolio/boq',
  },
  {
    id: '3',
    title: 'Bảng Spec Hoàn Thiện',
    icon: 'document-text-outline',
    route: '/projects/portfolio/spec',
  },
  {
    id: '4',
    title: 'Báo Giá, Hợp Đồng Thiết Kế',
    icon: 'receipt-outline',
    route: '/projects/portfolio/quotation',
  },
  {
    id: '5',
    title: '3D thiết kế nội thất',
    icon: 'cube-outline',
    route: '/projects/portfolio/3d-interior',
  },
  {
    id: '6',
