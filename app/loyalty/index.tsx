...
const rewards = [
  { id: '1', name: 'Voucher 50K', points: 500, image: 'https://via.placeholder.com/80/FF6B35/fff?text=50K' },
  { id: '2', name: 'Voucher 100K', points: 1000, image: 'https://via.placeholder.com/80/4CAF50/fff?text=100K' },
  { id: '3', name: 'Freeship', points: 300, image: 'https://via.placeholder.com/80/2196F3/fff?text=Ship' },
  { id: '4', name: 'Voucher 200K', points: 2000, image: 'https://via.placeholder.com/80/9C27B0/fff?text=200K' },
];

const history = [
  { id: '1', type: 'earn', description: 'Đơn hàng #ORD001', points: 285, date: '05/01/2026' },
  { id: '2', type: 'spend', description: 'Đổi voucher 100K', points: -1000, date: '03/01/2026' },
  { id: '3', type: 'earn', description: 'Đơn hàng #ORD002', points: 450, date: '28/12/2025' },
  { id: '4', type: 'earn', description: 'Đánh giá sản phẩm', points: 50, date: '25/12/2025' },
  { id: '5', type: 'bonus', description: 'Thưởng sinh nhật', points: 500, date: '20/12/2025' },
];
    ...
    <View style={[styles.container, { backgroundColor }]}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.pointsCard}>
          ...
          <Text style={styles.pointsValue}>{formatPoints(loyaltyInfo.points)}</Text>
          ...
          <View style={styles.progressSection}>
            ...
            <View style={styles.progressBar}>
              <View style={[styles.progressFill, { width: `${loyaltyInfo.tierProgress}%` }]} />
            </View>
            <Text style={styles.progressHint}>
              Còn {formatPoints(loyaltyInfo.pointsToNextTier)} điểm để lên {loyaltyInfo.nextTier}
            </Text>
          </View>
        </View>
        ...
        <View style={[styles.section, { backgroundColor: cardBg }]}>
          <View style={styles.sectionHeader}>
            <Text style={[styles.sectionTitle, { color: textColor }]}>Đổi điểm lấy quà</Text>
            <TouchableOpacity>
            ...
            {rewards.map((reward) => (
              <TouchableOpacity key={reward.id} style={styles.rewardCard}>
                ...
                <TouchableOpacity 
                  style={[
                    styles.redeemBtn,
                    loyaltyInfo.points < reward.points && styles.redeemBtnDisabled,
                  ]}
        ...
        {/* Tier Benefits */}
        <View style={[styles.section, { backgroundColor: cardBg }]}>
          <Text style={[styles.sectionTitle, { color: textColor }]}>Cấp bậc thành viên</Text>
            ...
            {tiers.map((tier, index) => (
              <View key={tier.name} style={styles.tierItem}>
                <View style={[
                  ...
                  tier.name === loyaltyInfo.tier && { backgroundColor: tier.color },
                ]}>
                ...
                <Text style={[
                  styles.tierName,
                  tier.name === loyaltyInfo.tier && { color: tier.color, fontWeight: 'bold' },
                ]}>
                  {tier.name}
                </Text>
                <Text style={styles.tierMinPoints}>{formatPoints(tier.minPoints)}</Text>
              </View>
            ))}
          </View>
        </View>
        ...
        <View style={[styles.section, { backgroundColor: cardBg }]}>
          <View style={styles.sectionHeader}>
            <Text style={[styles.sectionTitle, { color: textColor }]}>Lịch sử điểm</Text>
            <TouchableOpacity>
              <Text style={styles.viewAll}>Xem tất cả</Text>
            </TouchableOpacity>
          </View>
          {history.map((item) => (
            <View key={item.id} style={styles.historyItem}>
              ...
              <View style={styles.historyInfo}>
                <Text style={[styles.historyDesc, { color: textColor }]}>{item.description}</Text>
...
const styles = StyleSheet.create({
  ...
  pointsValue: { color: '#fff', fontSize: 42, fontWeight: 'bold', marginVertical: 8 },
  progressSection: { width: '100%', marginTop: 12 },
  progressLabels: { flexDirection: 'row', justifyContent: 'space-between' },
  progressText: { color: '#fff', opacity: 0.9, fontSize: 12 },
  progressBar: { height: 6, backgroundColor: 'rgba(255,255,255,0.3)', borderRadius: 3, marginVertical: 8 },
  progressFill: { height: '100%', backgroundColor: '#fff', borderRadius: 3 },
  progressHint: { color: '#fff', opacity: 0.9, fontSize: 12, textAlign: 'center' },
  ...
  rewardImage: { width: 80, height: 80, borderRadius: 12, backgroundColor: '#f0f0f0', marginBottom: 8 },
  rewardName: { fontSize: 13, fontWeight: '500', marginBottom: 4 },
  rewardPoints: { flexDirection: 'row', alignItems: 'center', gap: 4, marginBottom: 8 },
  rewardPointsText: { color: '#666', fontSize: 12 },
  redeemBtn: { backgroundColor: '#FF6B35', paddingHorizontal: 16, paddingVertical: 6, borderRadius: 4 },
  ...
  tierCircle: { width: 32, height: 32, borderRadius: 16, borderWidth: 2, justifyContent: 'center', alignItems: 'center', marginBottom: 6 },
