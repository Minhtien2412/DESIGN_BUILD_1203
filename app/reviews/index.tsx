...
const reviews = [
  ...
  },
  {
    ...
    productImage: 'https://via.placeholder.com/100',
    rating: 4,
    comment: 'Sơn lên rất mịn, màu đúng như hình. Chỉ tiếc là phải chờ hơi lâu.',
    date: '02/01/2026',
    images: [],
    likes: 8,
    helpful: false,
  },
  {
    ...
    workerImage: 'https://ui-avatars.com/api/?name=An&background=FF6B35&color=fff',
    workerSpecialty: 'Thợ điện',
    rating: 5,
    comment: 'Anh thợ rất nhiệt tình, làm việc cẩn thận và chuyên nghiệp. Sẽ thuê lại lần sau!',
    date: '28/12/2025',
...
export default function ReviewsScreen() {
    ...
    <View style={[styles.reviewCard, { backgroundColor: cardBg }]}>
      ...
      <View style={styles.actionsRow}>
        <TouchableOpacity style={styles.actionBtn}>
          ...
          />
          <Text style={[styles.actionText, item.helpful && { color: '#FF6B35' }]}>
            Hữu ích ({item.likes})
          </Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.actionBtn}>
  ...
  return (
    <View style={[styles.container, { backgroundColor }]}>
      <Stack.Screen options={{ title: 'Đánh giá của tôi', headerShown: true }} />
