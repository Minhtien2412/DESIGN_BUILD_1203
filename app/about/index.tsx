...
export default function AboutScreen() {
  ...
  const features = [
    { icon: 'home-outline', title: 'Thiết kế nội thất', desc: 'AI hỗ trợ thiết kế' },
    { icon: 'construct-outline', title: 'Quản lý dự án', desc: 'Theo dõi tiến độ xây dựng' },
    { icon: 'people-outline', title: 'Kết nối thợ', desc: 'Tìm thợ uy tín' },
    { icon: 'cart-outline', title: 'Mua sắm vật liệu', desc: 'Giá tốt nhất thị trường' },
  ];
    ...
    <View style={[styles.container, { backgroundColor }]}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.header}>
          ...
          <Text style={[styles.appName, { color: textColor }]}>App Design & Build</Text>
          <Text style={[styles.version, { color: '#666' }]}>Phiên bản 1.0.0</Text>
        ...
        <View style={[styles.section, { backgroundColor: cardBg }]}>
          ...
          {features.map((feature, index) => (
            <View key={index} style={styles.featureItem}>
              <View style={[styles.featureIcon, { backgroundColor: '#FF6B3520' }]}>
              ...
              <View style={styles.featureText}>
                ...
                <Text style={[styles.featureDesc, { color: '#666' }]}>{feature.desc}</Text>
              </View>
            </View>
          ))}
        </View>
        ...
        {/* Company Info */}
        <View style={[styles.section, { backgroundColor: cardBg }]}>
          <Text style={[styles.sectionTitle, { color: textColor }]}>Thông tin công ty</Text>
          <View style={styles.infoRow}>
            <Ionicons name="business-outline" size={20} color="#666" />
            <Text style={[styles.infoText, { color: textColor }]}>Công ty TNHH Bảo Tiến Web</Text>
          </View>
          <View style={styles.infoRow}>
            <Ionicons name="location-outline" size={20} color="#666" />
            <Text style={[styles.infoText, { color: textColor }]}>TP. Hồ Chí Minh, Việt Nam</Text>
          </View>
          <View style={styles.infoRow}>
            <Ionicons name="mail-outline" size={20} color="#666" />
            <Text style={[styles.infoText, { color: textColor }]}>contact@baotienweb.cloud</Text>
          </View>
          <View style={styles.infoRow}>
            <Ionicons name="globe-outline" size={20} color="#666" />
            <Text style={[styles.infoText, { color: textColor }]}>https://baotienweb.cloud</Text>
          </View>
        </View>

        {/* Social Links */}
        <View style={[styles.section, { backgroundColor: cardBg }]}>
          <Text style={[styles.sectionTitle, { color: textColor }]}>Kết nối với chúng tôi</Text>
          <View style={styles.socialRow}>
            <TouchableOpacity style={[styles.socialBtn, { backgroundColor: '#1877F2' }]}>
              <Ionicons name="logo-facebook" size={24} color="#fff" />
            </TouchableOpacity>
            <TouchableOpacity style={[styles.socialBtn, { backgroundColor: '#E4405F' }]}>
...
const styles = StyleSheet.create({
  ...
  copyright: { textAlign: 'center', color: '#999', fontSize: 12, paddingVertical: 24 },
});
