...
const styles = StyleSheet.create({
  ...
  dayItemActive: { backgroundColor: '#FF6B35' },
  dayName: { color: '#666', fontSize: 12, marginBottom: 4 },
  dayDate: { fontSize: 18, fontWeight: '600' },
  dayTextActive: { color: '#fff' },
  taskDot: { width: 6, height: 6, borderRadius: 3, backgroundColor: '#FF6B35', marginTop: 4 },
  ...
  todayBadge: { marginLeft: 8, backgroundColor: '#FF6B35', paddingHorizontal: 8, paddingVertical: 2, borderRadius: 10 },
  ...
  summaryNumber: { fontSize: 24, fontWeight: 'bold', color: '#FF6B35' },
