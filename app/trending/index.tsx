...
const trendingItems = [
  {
    ...
    image:
      "https://images.unsplash.com/photo-1615971677499-5467cbab01c0?w=300&h=200&q=80",
    price: 450000,
    rating: 4.9,
    sales: 2340,
    trend: "hot",
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?w=300&h=200&q=80",
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1562259949-e8e7689d7828?w=300&h=200&q=80",
    price: 1200000,
    rating: 4.8,
    sales: 1567,
    trend: "new",
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?w=300&h=200&q=80",
    ...
    return (
      ...
      >
        ...
        <View style={styles.trendingContent}>
          <Text
            style={[styles.trendingTitle, { color: textColor }]}
            numberOfLines={2}
          >
            {item.title}
          </Text>
            ...
            <>
              <View style={styles.statsRow}>
                ...
                <Text style={styles.statText}>
                  Đã bán {formatNumber(item.sales ?? 0)}
                </Text>
              </View>
          ...
          {item.type === "design" && (
            <>
              ...
              <View style={styles.statsRow}>
                ...
                <Text style={styles.statText}>
                  {formatNumber(item.likes ?? 0)} thích
                </Text>
              </View>
            </>
          )}
          ...
          {item.type === "worker" && (
            <>
              ...
              <Text style={styles.bookingsText}>
                {item.bookings} lượt đặt tuần này
              </Text>
            </>
          )}
        </View>
