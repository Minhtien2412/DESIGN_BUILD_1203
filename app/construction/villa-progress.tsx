...
const LEGEND_TAGS = [
  { label: "Sơn", color: "#0D9488" },
  { label: "ME - Hoà", color: "#14B8A6" },
    ...
    try {
      ...
      if (phasesResponse.success && phasesResponse.data) {
        ...
        const overallProgress =
          phases.length > 0 ? totalProgress / phases.length / 100 : 0;
              ...
              >
                ...
                <View style={styles.progressContainer}>
                  ...
                  <View style={styles.progressMetaRow}>
                    <Text
                      style={[styles.progressMeta, { color: theme.textMuted }]}
                    >
...
function getPhaseArea(phaseName: string): string {
  ...
  if (phaseName.includes("san lấp") || phaseName.includes("San lấp"))
    return "Nền";
  return "Thi công";
}
  ...
  return [
    ...
    },
    {
      ...
      tasks: [
        {
          code: "6.1",
          label: "San lấp - đệm nền (hố ga, thoát trệt)",
          progress: 0,
        },
    ...
    >
      <View style={styles.stageHeader}>
        ...
        <View style={styles.stageHeaderText}>
          ...
          <Text style={[styles.stageArea, { color: themeColors.textMuted }]}>
            {stage.area}
          </Text>
        </View>
        {/* Progress indicator */}
        ...
        >
          <Text style={[styles.progressBadgeText, { color: stage.accent }]}>
            {stage.progress}%
          </Text>
        </View>
      </View>
      <Text style={[styles.stageDescription, { color: themeColors.textMuted }]}>
        {stage.description}
      </Text>
      ...
      <View style={styles.miniProgressBar}>
        <View
          style={[
            ...
            { width: `${stage.progress}%`, backgroundColor: stage.accent },
          ]}
        />
      </View>
      ...
      {stage.tasks.slice(0, 4).map((task) => (
        <View key={task.code} style={styles.taskRow}>
          <Text
            style={[styles.taskLabel, { color: themeColors.text }]}
            numberOfLines={1}
          >
            {task.label}
          </Text>
      ...
      {stage.tasks.length > 4 && (
        <Text style={styles.moreTasksText}>
          +{stage.tasks.length - 4} công việc khác
        </Text>
      )}
    </View>
  );
...
function TimelineNode({
  ...
  return (
    <View style={styles.timelineNodeContainer}>
      {isFirst && (
        <Text style={[styles.timelineMarker, { color: THEME_COLORS.primary }]}>
          Bắt đầu
        </Text>
      )}
      {!isFirst && (
      ...
      <View
        style={[
          styles.timelineNode,
          {
            ...
            backgroundColor: stage?.status === "completed" ? nodeColor : "#fff",
          },
        ]}
      >
        {stage?.status === "completed" ? (
          ...
          <Text style={[styles.timelineNodeText, { color: nodeColor }]}>
            {stage?.id}
          </Text>
        )}
      </View>
      ...
      <Text style={[styles.timelineNodeLabel, { color: theme.textMuted }]}>
        {stage?.area}
      </Text>
      {isLast && (
        <Text
          style={[
            ...
            { color: THEME_COLORS.primary, marginTop: 6 },
          ]}
        >
          Kết thúc
        </Text>
