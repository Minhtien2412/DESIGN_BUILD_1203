...
const MOCK_PROJECT = {
  ...
  description: 'Dự án xây dựng biệt thự 3 tầng, 1 tầng hầm với thiết kế hiện đại. Công trình bao gồm hệ thống smart home, hồ bơi và sân vườn.',
};

const STATUS_CONFIG = {
  pending: { label: 'Chờ khởi công', color: '#6B7280', bgColor: '#F3F4F6', icon: 'time-outline' },
  in_progress: { label: 'Đang thi công', color: '#3B82F6', bgColor: '#EFF6FF', icon: 'construct-outline' },
  completed: { label: 'Hoàn thành', color: '#10B981', bgColor: '#ECFDF5', icon: 'checkmark-circle-outline' },
  suspended: { label: 'Tạm dừng', color: '#EF4444', bgColor: '#FEF2F2', icon: 'pause-circle-outline' },
};
        ...
        <View style={styles.headerContent}>
          ...
          <View style={styles.badgeRow}>
            ...
            <View style={[styles.priorityBadge, { backgroundColor: priorityConfig.color }]}>
              <Text style={styles.priorityBadgeText}>Ưu tiên {priorityConfig.label}</Text>
            </View>
          </View>
        </View>
    ...
    <>
      ...
      <View style={styles.statsGrid}>
        ...
        >
          ...
          <Text style={styles.statValue}>{project.stats.tasks.completed}/{project.stats.tasks.total}</Text>
        ...
        >
          ...
          <Text style={styles.statValue}>{formatCurrency(project.usedBudget).replace('₫', '')}</Text>
        ...
        <TouchableOpacity style={styles.statCard}>
          ...
          <Text style={styles.statValue}>{project.stats.issues.total - project.stats.issues.resolved}</Text>
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.cityText}>{project.ward}, {project.district}, {project.city}</Text>
        <TouchableOpacity 
      ...
      <View style={styles.card}>
        ...
        <View style={styles.timelineRow}>
          ...
          <View style={styles.timelineItem}>
            ...
            <Text style={styles.timelineValue}>{formatDate(project.estimatedEndDate)}</Text>
          </View>
        </View>
        <View style={styles.durationBadge}>
          <Ionicons name="time-outline" size={14} color="#666" />
          <Text style={styles.durationText}>Thời gian: {project.duration} ngày</Text>
        </View>
      </View>
      ...
      <View style={styles.card}>
        ...
        <View style={styles.budgetMain}>
          <Text style={styles.budgetTotal}>{formatCurrency(project.totalBudget)}</Text>
        ...
        <View style={styles.budgetProgress}>
          ...
          <Text style={styles.budgetPercent}>
            {((project.usedBudget / project.totalBudget) * 100).toFixed(1)}% đã sử dụng
          </Text>
        </View>
        <View style={styles.budgetDetails}>
          <View style={styles.budgetItem}>
            ...
            <Text style={styles.budgetItemValue}>{formatCurrency(project.usedBudget)}</Text>
          </View>
          <View style={styles.budgetItem}>
            <View style={[styles.budgetDot, { backgroundColor: '#E2E8F0' }]} />
            <Text style={styles.budgetItemLabel}>Còn lại:</Text>
            <Text style={styles.budgetItemValue}>{formatCurrency(project.remainingBudget)}</Text>
          </View>
        </View>
      </View>
    ...
    <>
      ...
      <View style={styles.card}>
        ...
        <View style={styles.personCard}>
          <Image source={{ uri: project.client.avatar }} style={styles.personAvatar} />
      ...
      <View style={styles.card}>
        ...
        <View style={styles.personCard}>
          <Image source={{ uri: project.projectManager.avatar }} style={styles.personAvatar} />
          <View style={styles.personInfo}>
      ...
      <View style={styles.card}>
        ...
        <View style={styles.personCard}>
          <Image source={{ uri: project.engineer.avatar }} style={styles.personAvatar} />
          <View style={styles.personInfo}>
      ...
      <View style={styles.quickLinks}>
        ...
        >
          ...
          <View style={styles.quickLinkBadge}>
            <Text style={styles.quickLinkBadgeText}>{project.stats.documents.total}</Text>
          </View>
        </TouchableOpacity>
