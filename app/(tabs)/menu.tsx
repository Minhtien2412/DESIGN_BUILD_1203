  ...
  // ====== QC/QA ======
  {
    ...
    items: [
      ...
      },
      {
        ...
        route: "/quality-assurance/checklists",
      },
      {
        id: "qa3",
        label: "Inspections",
        icon: "search-outline",
        route: "/quality-assurance/inspections",
      },
      {
        id: "qa4",
        label: "Defects",
        icon: "warning-outline",
        route: "/quality-assurance/defects",
      },
      {
        id: "qa5",
        label: "NCRs",
        icon: "alert-circle-outline",
        route: "/quality-assurance/ncr",
      },
      {
        id: "qa6",
        label: "Audit",
        icon: "clipboard-outline",
        route: "/quality-assurance/audit",
      },
      {
        id: "qa7",
        label: "Standards",
        icon: "ribbon-outline",
        route: "/quality-assurance/standards",
      },
    ],
  },
  ...
  // ====== SHOPPING ======
  {
    ...
    items: [
      ...
      },
      {
        ...
        label: "Nội thất",
        icon: "bed-outline",
        route: "/shopping/noi-that",
      },
      {
        id: "s9",
        label: "Thiết bị bếp",
        icon: "restaurant-outline",
        route: "/shopping/thiet-bi-bep",
      },
      {
        id: "s10",
        label: "PCCC",
  ...
  // ====== UTILITIES ======
  {
    ...
    items: [
      ...
      },
      {
        ...
        label: "Hoàn thiện",
        icon: "color-palette-outline",
        route: "/utilities/finishing",
      },
      {
        id: "ut6",
        label: "Equipment",
        icon: "hardware-chip-outline",
        route: "/utilities/equipment",
      },
      {
        id: "ut7",
        label: "Thư viện",
        icon: "library-outline",
        route: "/utilities/library",
      },
      {
        id: "ut8",
        label: "Weather",
    ...
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.searchContainer}>
          ...
          <TextInput
            nativeID="menu-search"
            accessibilityLabel="Tìm chức năng"
