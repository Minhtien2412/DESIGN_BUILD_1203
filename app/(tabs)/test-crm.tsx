    ...
    return (
      <SafeAreaView style={[styles.container, { backgroundColor }]}>
        <View style={styles.centered}>
          ...
          <Text style={[styles.title, { color: textColor }]}>Login Required</Text>
    ...
    <SafeAreaView style={[styles.container, { backgroundColor }]} edges={['top']}>
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.header}>
          <Text style={[styles.title, { color: textColor }]}>CRM Sync Test</Text>
          <SyncStatusBadge />
        </View>

        {/* User Info */}
        <View style={[styles.card, { backgroundColor: cardBg, borderColor }]}>
          <Text style={[styles.cardTitle, { color: textColor }]}>User Info</Text>
          <Text style={[styles.infoText, { color: textColor }]}>Email: {user.email}</Text>
        ...
        {/* Sync Status */}
        <View style={[styles.card, { backgroundColor: cardBg, borderColor }]}>
          <Text style={[styles.cardTitle, { color: textColor }]}>Sync Status</Text>
          <View style={styles.statusRow}>
            <Text style={[styles.infoText, { color: textColor }]}>CRM Linked:</Text>
            <Text style={[styles.statusValue, { color: isLinked ? '#22c55e' : '#ef4444' }]}>
              {isLinked ? '✅ Yes' : '❌ No'}
            </Text>
          </View>
          <View style={styles.statusRow}>
            <Text style={[styles.infoText, { color: textColor }]}>Last Sync:</Text>
          ...
          <View style={styles.statusRow}>
            <Text style={[styles.infoText, { color: textColor }]}>Data Version:</Text>
            <Text style={[styles.statusValue, { color: textColor }]}>
        ...
        {isLinked && crmData && (
          <>
            ...
            <Text style={[styles.sectionTitle, { color: textColor }]}>Invoices</Text>
            <CRMDataList type="invoices" limit={5} />

            <Text style={[styles.sectionTitle, { color: textColor }]}>Estimates</Text>
            <CRMDataList type="estimates" limit={5} />

            <Text style={[styles.sectionTitle, { color: textColor }]}>Tickets</Text>
