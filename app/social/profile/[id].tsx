  ...
  return (
    <View style={styles.profileHeader}>
      ...
      <View style={styles.coverContainer}>
        <Image
          source={{
            uri: profile.coverPhoto || 'https://via.placeholder.com/600x200/1877F2/FFFFFF',
          }}
      ...
      <View style={styles.avatarContainer}>
        <Image
          source={{ uri: profile.avatar || 'https://via.placeholder.com/168' }}
          style={styles.avatar}
        />
        {isOwnProfile && (
          ...
          {isOwnProfile ? (
            ...
            <>
              <TouchableOpacity
                style={[
                  styles.actionButton,
                  profile.isFollowing ? styles.secondaryButton : styles.primaryButton,
                ]}
                onPress={onFollow}
              >
                <Ionicons
