/**
 * Shorts Screen - Video ngắn kiểu TikTok/Instagram
 * Features: Vuốt dọc, like, comment, share, follow, bật/tắt âm thanh
 ...
 * @updated 29/01/2026 - Renamed from reels-viewer to shorts
 */
...
const SAMPLE_VIDEOS: Reel[] = [
  {
    ...
    videoUrl:
      "https://videos.pexels.com/video-files/3571264/3571264-sd_506_960_25fps.mp4",
    thumbnail:
      "https://images.pexels.com/videos/3571264/free-video-3571264.jpg?auto=compress&w=400",
  ...
  },
  {
    ...
    videoUrl:
      "https://videos.pexels.com/video-files/6394054/6394054-sd_360_640_25fps.mp4",
    thumbnail:
      "https://images.pexels.com/videos/6394054/free-video-6394054.jpg?auto=compress&w=400",
    description:
  ...
  },
  {
    ...
    videoUrl:
      "https://videos.pexels.com/video-files/7578549/7578549-sd_360_640_30fps.mp4",
    thumbnail:
      "https://images.pexels.com/videos/7578549/free-video-7578549.jpg?auto=compress&w=400",
  ...
  },
  {
    ...
    videoUrl:
      "https://videos.pexels.com/video-files/4625518/4625518-sd_360_640_30fps.mp4",
    thumbnail:
      "https://images.pexels.com/videos/4625518/free-video-4625518.jpg?auto=compress&w=400",
  ...
  },
  {
    ...
    videoUrl:
      "https://videos.pexels.com/video-files/5147956/5147956-sd_360_640_25fps.mp4",
    thumbnail:
      "https://images.pexels.com/videos/5147956/free-video-5147956.jpg?auto=compress&w=400",
  ...
  },
  {
    ...
    videoUrl:
      "https://videos.pexels.com/video-files/6394068/6394068-sd_360_640_25fps.mp4",
    thumbnail:
      "https://images.pexels.com/videos/6394068/free-video-6394068.jpg?auto=compress&w=400",
  ...
  },
  {
    ...
    videoUrl:
      "https://videos.pexels.com/video-files/5529607/5529607-sd_360_640_25fps.mp4",
    thumbnail:
      "https://images.pexels.com/videos/5529607/free-video-5529607.jpg?auto=compress&w=400",
    description:
      "🏰 Biệt thự sang trọng nhất 2026\n\n#villa #luxury #realestate",
    music: "♪ Luxury Life",
    likes: 78901,
    comments: 1234,
    shares: 2345,
  ...
  },
  {
    ...
    videoUrl:
      "https://videos.pexels.com/video-files/6394032/6394032-sd_360_640_25fps.mp4",
    thumbnail:
      "https://images.pexels.com/videos/6394032/free-video-6394032.jpg?auto=compress&w=400",
  ...
  },
  {
    ...
    videoUrl:
      "https://videos.pexels.com/video-files/4109301/4109301-sd_360_640_25fps.mp4",
    thumbnail:
      "https://images.pexels.com/videos/4109301/free-video-4109301.jpg?auto=compress&w=400",
  ...
  },
  {
    ...
    videoUrl:
      "https://videos.pexels.com/video-files/5529579/5529579-sd_360_640_25fps.mp4",
    thumbnail:
      "https://images.pexels.com/videos/5529579/free-video-5529579.jpg?auto=compress&w=400",
  ...
  },
  {
    ...
    videoUrl:
      "https://videos.pexels.com/video-files/6394084/6394084-sd_360_640_25fps.mp4",
    thumbnail:
      "https://images.pexels.com/videos/6394084/free-video-6394084.jpg?auto=compress&w=400",
  ...
  },
  {
    ...
    videoUrl:
      "https://videos.pexels.com/video-files/4109265/4109265-sd_360_640_25fps.mp4",
    thumbnail:
      "https://images.pexels.com/videos/4109265/free-video-4109265.jpg?auto=compress&w=400",
...
export function searchVideos(query: string): Reel[] {
  ...
  return SAMPLE_VIDEOS.filter((video) => {
    ...
    // Tìm trong tags
    if (video.tags.some((tag) => tag.toLowerCase().includes(normalizedQuery)))
      return true;

    // Tìm trong searchKeywords
    if (
      video.searchKeywords?.some((kw) =>
...
const SAMPLE_COMMENTS = [
  ...
  },
  {
    ...
    content: "Cho em hỏi chi phí khoảng bao nhiêu ạ?",
    likes: 89,
    time: "3h",
    replies: 8,
  },
  {
    ...
    content: "Rất chuyên nghiệp! Đã theo dõi ❤️",
    likes: 156,
    time: "5h",
    replies: 3,
  },
  {
    ...
    content: "Ước gì nhà mình cũng đẹp như vậy 🏠",
    likes: 67,
    time: "6h",
    replies: 1,
  },
  {
    ...
    content: "Anh ơi cho em xin số tư vấn với ạ",
    likes: 45,
    time: "8h",
    replies: 5,
  },
...
const ReelItem = ({
  ...
  const player = useVideoPlayer(isRealVideo ? reel.videoUrl : null, (player) => {
    player.loop = true;
  ...
  }, [isActive, isPaused, isRealVideo, player]);

  useEffect(() => {
    if (!isRealVideo) return;
    player.muted = isMuted;
  }, [isMuted, isRealVideo, player]);
      ...
      <View style={[styles.reelInfo, { paddingBottom: insets.bottom + 80 }]}>
        ...
        <TouchableOpacity style={styles.reelUserInfo} onPress={onUserPress}>
          <Text style={styles.reelUserName}>
            @{reel.user.name.toLowerCase().replace(/ /g, "_")}
          </Text>
          {reel.user.verified && (
            <Ionicons
...
export default function ReelsViewerScreen() {
  ...
  const loadReels = useCallback(
    async (page = 1, category = "all", refresh = false) => {
      try {
        if (page === 1) {
          setIsLoading(true);
        } else {
        ...
        console.log(
          `[Reels] Loading page ${page}, category: ${category}, refresh: ${refresh}`,
        );
        ...
        if (serverResponse.reels.length > 0) {
          console.log(
            `[Reels] 🚀 Loaded ${serverResponse.reels.length} videos from Server Cache`,
          );
          ...
          if (refresh || page === 1) {
            ...
            setReels((prev) => {
              ...
              const newReels = serverResponse.reels.filter(
          ...
          if (serverResponse.stats) {
            ...
            console.log(
              `[Reels] Stats: watched=${serverResponse.stats.watched}, remaining=${serverResponse.stats.remaining}`,
            );
          }
        ...
        if (response.reels.length > 0) {
          ...
          console.log(
            `[Reels] Loaded ${response.reels.length} reels from ${response.source}`,
          );
        } else {
  ...
  useEffect(() => {
    const loadStats = async () => {
      ...
      if (stats) {
        console.log(
          `[Reels] 📊 Server: ${stats.videoCount} videos, ${stats.usedPercent}% used`,
        );
      }
    };
    loadStats();
  ...
  useEffect(() => {
    ...
    if (targetId && reels.length > 0) {
      ...
      if (index >= 0) {
        console.log(
          `[Reels] Found video at index ${index}: ${reels[index].title || reels[index].id}`,
        );
        ...
        if (sampleVideo) {
          console.log(
            `[Reels] Video found in samples, adding to reels: ${sampleVideo.title}`,
          );
    ...
    ({ viewableItems }: { viewableItems: ViewToken[] }) => {
      if (viewableItems.length > 0 && viewableItems[0].index !== null) {
        ...
        if (currentReelId.current && watchStartTime.current > 0) {
          ...
          const prevReel = reelsRef.current.find(
            (r) => r.id === currentReelId.current,
          );
          ...
          if (watchDuration > 0) {
            ...
            if (prevReel?.source === "server") {
              recordServerView(
                currentReelId.current,
                watchDuration,
                watchDuration >= 5,
              );
            }
            console.log(
              `[Reels] ⏱️ Watched ${currentReelId.current} for ${watchDuration}s`,
            );
          }
        }
  ...
  const handleLike = useCallback(
    async (reelId: string) => {
      ...
      // Call API to persist
      try {
        const response = await videoInteractionsApi.toggleVideoLike({
          videoId: reelId,
          userId: user?.id || "",
        });
        if (response.success) {
  ...
  const loadComments = useCallback(
    async (videoId: string, page = 1, reset = false) => {
  ...
  const handleSendComment = useCallback(async () => {
    if (!commentText.trim() || !selectedReel || !user || isSendingComment)
      return;
    ...
    try {
      ...
      if (response.success && response.comment) {
        ...
        setReels((prev) =>
          prev.map((r) =>
            r.id === selectedReel.id ? { ...r, comments: r.comments + 1 } : r,
          ),
        );
      ...
      prev.map((r) =>
        r.id === reelId
          ? {
              ...r,
              saved: !r.saved,
              saves: r.saved ? (r.saves || 0) - 1 : (r.saves || 0) + 1,
            }
          : r,
      ),
    );
    ...
    try {
      ...
      if (response.success) {
        setReels((prev) =>
          prev.map((r) =>
            r.id === reelId
              ? { ...r, saved: response.saved, saves: response.savesCount }
              : r,
          ),
        );
      }
  ...
  const handleDownload = useCallback(async (reel: Reel) => {
    try {
      ...
      try {
        const response = await videoInteractionsApi.recordVideoDownload(
          reel.id,
        );
        if (response.success) {
          console.log(
            `[Reels] ⬇️ Download tracked: ${response.downloadsCount}`,
          );
        }
      } catch {
    ...
    <View style={styles.container}>
        ...
        <View style={[styles.serverStatsOverlay, { top: insets.top + 60 }]}>
          <View style={styles.statsChip}>
            ...
            <Text style={styles.statsChipText}>
              {serverStats.watched}/
              {serverStats.watched + serverStats.remaining}
            </Text>
          </View>
          ...
          {VIDEO_CATEGORIES.map((cat) => (
            ...
            >
              <Ionicons
                ...
                size={14}
                color={
                  selectedCategory === cat.id ? "#fff" : "rgba(255,255,255,0.8)"
                }
              />
              <Text
                style={[
      ...
      >
        <View style={styles.commentsOverlay}>
          ...
          <View
            style={[styles.commentsSheet, { paddingBottom: insets.bottom }]}
          >
            {/* Handle */}
                  ...
                  <View style={styles.commentContent}>
                    <View style={styles.commentHeader}>
                      <Text style={styles.commentUser}>
                        {item.user?.name || item.userName || "User"}
                      </Text>
                    ...
                    <View style={styles.commentActions}>
                      ...
                      <TouchableOpacity style={styles.commentAction}>
                        ...
                        />
                        <Text style={styles.commentActionText}>
                          {item.repliesCount || item.replies?.length || 0} phản
                          hồi
                        </Text>
                      </TouchableOpacity>
                    </View>
            ...
            <View style={styles.commentInputContainer}>
              ...
              <TouchableOpacity
                style={[
                  styles.sendButton,
                  (!commentText.trim() || !user || isSendingComment) &&
