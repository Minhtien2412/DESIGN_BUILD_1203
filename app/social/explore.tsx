/**
 * Explore Screen - Khám phá video xây dựng
 * Features: Lọc theo danh mục, video trending, creators, grid view
 * Theme: Monochrome (#1a1a1a, #9ca3af, #fafafa)
 * Route: /social/explore
 * @author AI Assistant
 * @date 16/01/2026
 * @updated 29/01/2026 - Renamed from video-discovery to explore
 */
...
const TRENDING_VIDEOS = [
  {
    ...
    user: {
      name: "Kiến Trúc A&A",
      avatar: "https://i.pravatar.cc/150?u=arch1",
      verified: true,
    },
    views: "1.2M",
    duration: "5:45",
...
const ALL_VIDEOS = [
  ...
  },
  {
    ...
    title: "Đổ bê tông đúng kỹ thuật",
    user: "Xây Dựng Pro",
    views: "234K",
    duration: "8:45",
    category: "thicong",
...
export default function VideoDiscoveryScreen() {
  ...
  const handleVideoPress = (videoId: string) => {
    router.push(`/social/shorts?id=${videoId}` as any);
  };
  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      >
        ...
        <SectionHeader
          title="Xu hướng"
          onSeeAll={() => router.push("/social/shorts")}
        />
        <ScrollView
          horizontal
          showsHorizontalScrollIndicator={false}
