...
> = {
  ...
  ACTIVE: { label: 'Đang thực hiện', color: '#0D9488', icon: 'checkmark-circle' },
  COMPLETED: { label: 'Hoàn thành', color: '#0D9488', icon: 'checkmark-done' },
