...
const PHASE_COLORS = [
  { value: '#2196F3', label: 'Xanh dương', icon: 'water' },
  { value: '#4CAF50', label: 'Xanh lá', icon: 'leaf' },
  { value: '#F44336', label: 'Đỏ', icon: 'flame' },
  { value: '#FF9800', label: 'Cam', icon: 'sunny' },
  { value: '#10B981', label: 'Tím', icon: 'flower' },
  { value: '#0A6847', label: 'Hồng', icon: 'heart' },
              ...
              {PHASE_ICONS.map((iconItem) => (
                ...
                >
                  <Ionicons 
                    ...
                    size={24} 
                    color={selectedIcon === iconItem.value ? '#2196F3' : '#666'} 
                  />
                  <Text style={[
                    styles.iconLabel,
