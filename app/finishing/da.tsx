...
const WORKERS: Worker[] = [
  {
    ...
    price: '300.000₫',
    priceUnit: '/ m²',
    specialties: ['Đá marble', 'Đá granite', 'Ốp cầu thang', 'Bàn bếp'],
    teamSize: 5,
    completedProjects: 412,
    avatar: '💎',
    featured: true,
    availability: 'available',
    pricePerDay: '1.200.000₫/ngày',
  },
  {
    id: 2,
    name: 'Thợ Đá Chuyên Nghiệp',
    rating: 4.8,
    reviews: 167,
    location: 'Hà Nội',
    experience: 16,
    price: '280.000₫',
    priceUnit: '/ m²',
    specialties: ['Đá granite', 'Đá nhân tạo', 'Ốp tường', 'Lát sàn'],
    teamSize: 4,
    completedProjects: 368,
    avatar: '🪨',
    featured: true,
    availability: 'available',
    pricePerDay: '1.100.000₫/ngày',
  },
  {
    id: 3,
    name: 'Đá Granite Miền Trung',
    rating: 4.7,
    reviews: 145,
    location: 'Đà Nẵng',
    experience: 14,
    price: '250.000₫',
    priceUnit: '/ m²',
    specialties: ['Đá granite', 'Đá ốp lát', 'Bàn bếp', 'Cầu thang'],
    teamSize: 4,
    completedProjects: 298,
    avatar: '🔷',
    availability: 'available',
    pricePerDay: '950.000₫/ngày',
  },
  {
    id: 4,
    name: 'Thợ Đá Phương Nam',
    rating: 4.6,
    reviews: 128,
    location: 'Cần Thơ',
    experience: 12,
    price: '220.000₫',
    priceUnit: '/ m²',
    specialties: ['Đá nhân tạo', 'Đá ốp tường', 'Lát sàn', 'Bàn làm việc'],
    teamSize: 3,
...
const STONE_TYPES = ['Tất cả', 'Đá marble', 'Đá granite', 'Đá nhân tạo', 'Đá ốp lát', 'Bàn bếp'];

export default function StoneWorkerScreen() {
  const [searchQuery, setSearchQuery] = useState('');
  const [selectedLocation, setSelectedLocation] = useState('Tất cả');
  const [selectedStoneType, setSelectedStoneType] = useState('Tất cả');
  ...
  const filteredWorkers = WORKERS.filter((worker) => {
    ...
    const matchesStoneType =
      selectedStoneType === 'Tất cả' ||
      worker.specialties.some((s) => s.includes(selectedStoneType));

    return matchesSearch && matchesLocation && matchesStoneType;
  });
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Thợ đá</Text>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        {/* Stone Type Filter */}
        <View style={styles.filterSection}>
          <Text style={styles.filterLabel}>Loại đá</Text>
          <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.filterScroll}>
            {STONE_TYPES.map((type) => (
              <TouchableOpacity
                ...
                style={[
                  styles.filterChip,
                  selectedStoneType === type && styles.filterChipActive,
                ]}
              ...
              >
                <Text
                  style={[
                    styles.filterChipText,
                    selectedStoneType === type && styles.filterChipTextActive,
                  ]}
                >
                  {type}
                </Text>
        ...
        <View style={styles.resultsHeader}>
          <Text style={styles.resultsCount}>
            {filteredWorkers.length} thợ đá
          </Text>
          {(selectedLocation !== 'Tất cả' || selectedStoneType !== 'Tất cả' || searchQuery) && (
        ...
        {filteredWorkers.length > 0 ? (
          ...
          <View style={styles.emptyState}>
            ...
            <Text style={styles.emptyText}>Không tìm thấy thợ đá</Text>
        ...
        >
          <View style={styles.modalContent}>
            ...
            <ScrollView style={styles.modalForm} showsVerticalScrollIndicator={false}>
              ...
              <View style={styles.formGroup}>
                <Text style={styles.formLabel}>Loại đá</Text>
                <TextInput
                  style={styles.formInput}
                  placeholder="VD: Đá marble trắng"
                  value={bookingForm.stoneType}
                  onChangeText={(text) => setBookingForm({ ...bookingForm, stoneType: text })}
                />
              </View>
              ...
              <View style={styles.formGroup}>
                ...
                <TextInput
                  style={styles.formInput}
                  placeholder="Nhập diện tích cần thi công"
