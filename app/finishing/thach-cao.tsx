...
// Mock data - Gypsum/Drywall Workers
const WORKERS = [
  {
    id: 1,
    name: 'Đội Thạch Cao Chuyên Nghiệp',
    ...
    price: '120.000₫',
    priceUnit: '/ m²',
    specialties: ['Trần thạch cao', 'Vách ngăn', 'Trần chìm', 'Tạo hình 3D'],
    teamSize: 5,
  ...
  },
  {
    ...
    price: '110.000₫',
    priceUnit: '/ m²',
    specialties: ['Trần thạch cao', 'Vách ngăn', 'Trần chìm'],
    teamSize: 4,
  ...
  },
  {
    ...
    price: '100.000₫',
    priceUnit: '/ m²',
    specialties: ['Trần thạch cao', 'Vách ngăn'],
    teamSize: 3,
  ...
  },
  {
    ...
    price: '95.000₫',
    priceUnit: '/ m²',
    specialties: ['Trần thạch cao', 'Sửa chữa'],
    teamSize: 2,
    completedProjects: 214,
    featured: false,
    availability: 'Bận (khả dụng từ 15/12)',
    phone: '093 999 0000',
...
const WORK_TYPES = ['Tất cả', 'Trần thạch cao', 'Vách ngăn', 'Trần chìm', 'Tạo hình 3D', 'Sửa chữa'];
...
export default function ThachCaoScreen() {
  ...
  const filteredWorkers = WORKERS.filter((worker) => {
    ...
    const matchWorkType = selectedWorkType === 'Tất cả' || worker.specialties.includes(selectedWorkType);
    const matchSearch = searchQuery === '' || worker.name.toLowerCase().includes(searchQuery.toLowerCase());
    return matchLocation && matchWorkType && matchSearch;
  });
    ...
    <>
      ...
      <View style={styles.container}>
          ...
          <View style={styles.filterRow}>
            ...
            <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.filterScroll}>
              {WORK_TYPES.map((type) => (
                ...
                >
                  <Text style={[styles.filterChipText, selectedWorkType === type && styles.filterChipTextActive]}>
                    {type}
                  </Text>
                </TouchableOpacity>
              ))}
        ...
        <View style={styles.resultsBar}>
          <Text style={styles.resultsText}>{filteredWorkers.length} đội</Text>
        </View>
        ...
        <View style={styles.bookingModalOverlay}>
          <View style={styles.bookingModalContent}>
            <View style={styles.bookingModalHeader}>
              <Text style={styles.bookingModalTitle}>Liên hệ thợ thạch cao</Text>
            ...
            <ScrollView style={styles.bookingModalBody}>
              ...
              <View style={styles.form}>
                ...
                <View style={styles.formGroup}>
                  ...
                  <TextInput
                    style={styles.formInput}
                    placeholder="VD: Trần thạch cao phòng khách"
