  ...
  const renderCard = ({ item: e }: { item: MEPEngineer }) => (
    ...
    >
      ...
      <View style={st.expBadge}>
        <Ionicons name="water" size={12} color="#03A9F4" />
      ...
      <View style={st.cardBody}>
        ...
        {e.certification && (
          <View style={st.certRow}>
            <Ionicons name="ribbon-outline" size={14} color="#0277BD" />
            <Text style={st.certText}>{e.certification}</Text>
          </View>
        )}
        <View style={st.statsRow}>
          <View style={st.stat}>
            <Ionicons name="star" size={14} color="#03A9F4" />
    ...
    return (
      <>
        ...
        <View style={st.center}>
          ...
          <Text style={st.loadText}>Đang tải danh sách kỹ sư nước...</Text>
        </View>
      </>
    );
          ...
          ListEmptyComponent={
            <View style={st.empty}>
              ...
              <Text style={st.emptyText}>
                Không tìm thấy kỹ sư nước phù hợp
              </Text>
              <TouchableOpacity
                style={st.resetBtn}
                onPress={() => {
...
const st = StyleSheet.create({
  ...
  chipActive: { backgroundColor: "#0277BD" },
  ...
  certText: { fontSize: 12, color: "#0277BD", fontWeight: "600" },
  statsRow: {
    flexDirection: "row",
    alignItems: "center",
    marginBottom: 10,
  ...
  tagText: { fontSize: 12, color: "#0277BD", fontWeight: "500" },
  footer: {
    flexDirection: "row",
  ...
  priceValue: { fontSize: 16, fontWeight: "700", color: "#0277BD" },
  contactBtn: {
