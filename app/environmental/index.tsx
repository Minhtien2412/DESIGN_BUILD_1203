...
const MONITORING_TYPE_ICONS: Record<
  MonitoringType,
...
const MOCK_ENV_PERMITS = [
  {
    id: "ep-1",
    title: "Giấy phép xả thải khí",
    authority: "Sở TN&MT",
    status: "ACTIVE" as const,
    issued: "2024-06-01",
    expiry: "2025-06-01",
    number: "XTKH-2024-0156",
  },
  {
    id: "ep-2",
    title: "Giấy phép xử lý chất thải nguy hại",
    authority: "Sở TN&MT",
    status: "ACTIVE" as const,
    issued: "2024-03-15",
    expiry: "2025-03-15",
    number: "CTNH-2024-0089",
  },
  {
    id: "ep-3",
    title: "Báo cáo ĐTM được phê duyệt",
    authority: "UBND Tỉnh",
    status: "ACTIVE" as const,
    issued: "2023-09-10",
    expiry: "2026-09-10",
    number: "DTM-2023-0234",
  },
  {
    id: "ep-4",
    title: "Giấy phép xả nước thải",
    authority: "Sở TN&MT",
    status: "EXPIRING" as const,
    issued: "2024-02-01",
    expiry: "2025-02-01",
    number: "XNT-2024-0045",
  },
  {
    id: "ep-5",
    title: "Giấy phép khai thác nước ngầm",
    authority: "Sở TN&MT",
...
const getEmissionTrendColor = (trend: string) => {
  switch (trend) {
    case "up":
      return "#ef4444";
    case "down":
...
const getEnvPermitStatusColor = (status: string) => {
  switch (status) {
    case "ACTIVE":
      return "#10b981";
    case "EXPIRING":
...
export default function EnvironmentalScreen() {
  ...
  const [selectedTab, setSelectedTab] = useState<
    "monitoring" | "waste" | "emissions" | "permits"
  >("monitoring");
  ...
  const { monitoring, loading: monitoringLoading } = useEnvironmentalMonitoring(
    { projectId },
  );
  const { wasteRecords, loading: wasteLoading } = useWasteRecords({
    projectId,
  });
  ...
  const filteredMonitoring = monitoring.filter(
    (item) =>
      monitoringStatusFilter === "ALL" ||
      item.status === monitoringStatusFilter,
  );
      ...
      <Container>
        ...
        <Section>
          ...
          <View style={styles.statsGrid}>
            ...
            >
              ...
              <ThemedText
                variant="h3"
                style={[styles.statValue, { color: "#0D9488" }]}
              >
            ...
            >
              ...
              <ThemedText
                ...
                style={[
                  styles.statValue,
                  { color: summary?.incidents ? "#0D9488" : "#0D9488" },
                ]}
              >
                {summary?.incidents || 0}
              </ThemedText>
            ...
            <View style={styles.tabContainer}>
              <TouchableOpacity
                style={[
                  styles.tab,
                  {
                    borderColor,
                    backgroundColor:
                      selectedTab === "monitoring" ? tintColor : surfaceColor,
                  },
                ]}
              ...
              >
                <ThemedText
                  ...
                  style={[
                    styles.tabText,
                    {
                      color: selectedTab === "monitoring" ? "#fff" : textColor,
                    },
                  ]}
                >
                  Monitoring
              ...
              <TouchableOpacity
                style={[
                  styles.tab,
                  {
                    borderColor,
                    backgroundColor:
                      selectedTab === "waste" ? tintColor : surfaceColor,
                  },
                ]}
              ...
              >
                <ThemedText
                  ...
                  style={[
                    styles.tabText,
                    { color: selectedTab === "waste" ? "#fff" : textColor },
                  ]}
                >
                  Waste
                </ThemedText>
              ...
              <TouchableOpacity
                style={[
                  styles.tab,
                  {
                    borderColor,
                    backgroundColor:
                      selectedTab === "emissions" ? tintColor : surfaceColor,
                  },
                ]}
              ...
              >
                <ThemedText
                  ...
                  style={[
                    styles.tabText,
                    { color: selectedTab === "emissions" ? "#fff" : textColor },
                  ]}
                >
                  Emissions
                </ThemedText>
        ...
        {selectedTab === "monitoring" && (
          <>
            ...
            <Section>
              {monitoringLoading ? (
                <ThemedText variant="body" style={{ color: textMutedColor }}>
                  Loading monitoring...
                </ThemedText>
                ...
                >
                  ...
                  <ThemedText
                    variant="body"
                    style={{ color: textMutedColor, marginTop: 12 }}
                  >
                  ...
                  >
                    <View style={styles.cardHeader}>
                      <View style={styles.cardHeaderLeft}>
                        ...
                        <ThemedText
                          variant="body"
                          style={[styles.itemNumber, { color: textMutedColor }]}
                        >
                      ...
                      <View style={styles.badges}>
                        ...
                        <View
                          style={[
                            styles.statusBadge,
                            {
                              backgroundColor: getMonitoringStatusColor(
                                item.status,
                              ),
                            },
                          ]}
                    ...
                    >
                      <ThemedText
                        variant="caption"
                        style={{ color: tintColor, fontWeight: "600" }}
                      >
                        {item.monitoringType}
                      </ThemedText>
                    </View>
                ...
                >
                  ...
                  {waste.disposalMethod && (
                    <View
                      style={[
                        styles.infoBox,
                        { backgroundColor, borderColor, marginTop: 12 },
                      ]}
                    >
                      <ThemedText
                        variant="caption"
          ...
          <>
            <Section>
              <View style={styles.emissionsSummary}>
                <View
                  style={[
                    styles.emissionsSummaryCard,
                    { backgroundColor: surfaceColor, borderColor },
                  ]}
                >
                  <Ionicons name="cloud" size={24} color="#ef4444" />
                ...
                >
                  ...
                  <ThemedText
                    variant="h3"
                    style={{ marginTop: 8, color: "#10b981" }}
                  >
                    -12%
                  </ThemedText>
                  <ThemedText
                  ...
                  <View style={styles.cardHeader}>
                    <View style={[styles.cardHeaderLeft, { flex: 1 }]}>
                      ...
                      <View style={{ flex: 1 }}>
                        ...
                        <ThemedText
                          variant="caption"
                          style={{ color: textMutedColor, marginTop: 2 }}
                        >
                          {item.period}
                        </ThemedText>
                      </View>
                    ...
                    >
                      <ThemedText variant="h4" style={{ fontWeight: "700" }}>
                        {item.amount} {item.unit}
                      </ThemedText>
                      <Ionicons
                        name={getEmissionTrendIcon(item.trend)}
                        size={18}
                        color={getEmissionTrendColor(item.trend)}
                      />
                    </View>
                  </View>
                  <View
            ...
            <Section>
              <View style={styles.emissionsSummary}>
                ...
                >
                  ...
                  <ThemedText variant="h3" style={{ marginTop: 8 }}>
                    {
                      MOCK_ENV_PERMITS.filter((p) => p.status === "ACTIVE")
                        .length
                    }
                  </ThemedText>
                  <ThemedText
                ...
                >
                  ...
                  <ThemedText
                    variant="h3"
                    style={{ marginTop: 8, color: "#f59e0b" }}
                  >
                    {
                      MOCK_ENV_PERMITS.filter(
                        (p) =>
                          p.status === "EXPIRING" || p.status === "PENDING",
                      ).length
                    }
                  </ThemedText>
                  <ThemedText
                ...
                >
                  <View style={styles.cardHeader}>
                    ...
                    <View
                      style={[
                        styles.statusBadge,
                        {
                          backgroundColor: getEnvPermitStatusColor(item.status),
                        },
                      ]}
                    >
                  ...
                  <View style={styles.infoGrid}>
                    <View style={styles.infoItem}>
                      ...
                      <ThemedText variant="body">{item.authority}</ThemedText>
                    </View>
                    {item.issued ? (
                      <View style={styles.infoItem}>
                        <ThemedText
                        ...
                        <ThemedText variant="body">{item.issued}</ThemedText>
                      </View>
                    ) : null}
                    {item.expiry ? (
                      <View style={styles.infoItem}>
