      ...
      <View style={[styles.activityCard, { borderColor }]}>
        ...
        <View style={styles.activityContent}>
          <View style={styles.header}>
            ...
            <Text style={[styles.timestamp, { color: textMutedColor }]}>
          ...
          {item.data && (
            <View style={[styles.dataCard, { backgroundColor: surfaceColor }]}>
              <Text style={[styles.dataText, { color: textMutedColor }]}>
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <View style={styles.emptyContainer}>
            <Ionicons name="pulse-outline" size={64} color={textMutedColor} />
