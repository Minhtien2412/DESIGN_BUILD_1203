...
const CATEGORIES = ['Tất cả', 'Công tắc', 'Dây điện', 'Đèn LED', 'Ổ cắm', 'MCB/ELCB'];
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Thiết bị điện</Text>
