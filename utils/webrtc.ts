...
export const MediaStream =
  WebRTCModule?.MediaStream || class MediaStreamFallback {};
export const MediaStreamTrack =
  WebRTCModule?.MediaStreamTrack || class MediaStreamTrackFallback {};
export const RTCIceCandidate =
  WebRTCModule?.RTCIceCandidate || class RTCIceCandidateFallback {};
...
export const RTCSessionDescription =
  WebRTCModule?.RTCSessionDescription || class RTCSessionDescriptionFallback {};
