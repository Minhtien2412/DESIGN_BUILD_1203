...
import { FlatList, ListRenderItem, RefreshControl, StyleSheet, Text, TouchableOpacity, ViewStyle } from 'react-native';
...
export const OptimizedFlatList = memo(<T,>({
  ...
  const memoizedRenderItem = useCallback<ListRenderItem<T>>((props) => {
...
export const OptimizedImage = memo(({
  source,
  style,
  placeholder = 'https://via.placeholder.com/300x200/f0f0f0/888888?text=Loading',
  contentFit = 'cover',
  transition = 300,
