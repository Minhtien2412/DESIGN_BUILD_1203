    ...
    <View style={[styles.container, compact && styles.compactContainer, style]}>
      <View style={styles.header}>
        ...
        >
          ...
          <MaterialIcons name="chevron-right" size={16} color="#0D9488" />
        </Pressable>
      </View>
      ...
      <View style={[styles.quickActions, compact && styles.compactQuickActions]}>
        <Pressable 
          ...
          onPress={() => router.push('/contact-picker' as any)}
        >
          <MaterialCommunityIcons name="account-multiple-plus" size={16} color="#0D9488" />
        ...
        >
          <MaterialCommunityIcons name="phone-plus" size={16} color="#0D9488" />
