...
export function DeviceSecurityAlert({
  ...
  const handleShowNativeAlert = React.useCallback(() => {
    if (Platform.OS !== 'web') {
      Alert.alert(
        'C?nh báo b?o m?t',
        warningMessage || 'Phát hi?n dang nh?p t? thi?t b? m?i!',
        [
          {
            text: 'Ð?i m?t kh?u',
            style: 'destructive',
  ...
  React.useEffect(() => {
    if (visible && isNewDevice && Platform.OS !== 'web') {
      // Hi?n th? Alert native trên mobile
      ...
      <View style={styles.overlay}>
        <View style={[styles.container, { backgroundColor }]}>
              ...
              <View style={styles.deviceList}>
                ...
                {otherDevices.length > 2 && (
                  <Text style={[styles.moreDevices, { color: textColor + '80' }]}>
                    và {otherDevices.length - 2} thi?t b? khác...
                  </Text>
                )}
              </View>
            )}
          ...
          <View style={styles.actions}>
            ...
            >
              <Text style={styles.buttonText}>Ð?i m?t kh?u</Text>
            </Pressable>
            ...
            >
              <Text style={styles.buttonText}>Tin c?y thi?t b? này</Text>
            </Pressable>
          </View>
