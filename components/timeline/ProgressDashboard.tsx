...
export function ProgressDashboard({ phases, projectName }: ProgressDashboardProps) {
    ...
    <View style={[styles.container, { backgroundColor, borderColor }]}>
      ...
      <View style={styles.statsGrid}>
        ...
        <View style={[styles.statCard, { backgroundColor, borderColor }]}>
          ...
          <Text style={[styles.statValue, { color: textColor }]}>{totalPhases}</Text>
          <Text style={[styles.statLabel, { color: textColor }]}>Tổng giai đoạn</Text>
        </View>
      ...
      <View style={styles.statusBreakdown}>
        <Text style={[styles.sectionTitle, { color: textColor }]}>Phân bổ trạng thái</Text>
