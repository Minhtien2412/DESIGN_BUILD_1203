...
export const VoiceSearchModal: React.FC<Props> = ({
  ...
  const { supported, state, transcript, error, start, stop, reset } =
          ...
          {disabled ? (
            <View style={styles.center}>
              ...
              <Text style={styles.desc}>
                Thiết bị hiện tại chưa hỗ trợ nhận diện giọng nói trực tiếp.
              </Text>
              <Text style={styles.note}>
                Dùng trình duyệt web hoặc bật bản Dev Build có tích hợp STT.
              </Text>
            </View>
          ) : (
            <>
              ...
              <View style={{ paddingHorizontal: 16, marginTop: 12 }}>
                <Text style={styles.hint}>
                  {isListening ? "Đang nghe..." : "Chạm để bắt đầu nói"}
                </Text>
                {!!transcript && (
