...
const styles = StyleSheet.create({
  ...
  backButton: { paddingHorizontal: 24, paddingVertical: 12, backgroundColor: '#0D9488', borderRadius: 8 },
  ...
  statusActive: { backgroundColor: '#0D9488' },
  ...
  uploadBtn: { flex: 1, alignItems: 'center', padding: 16, backgroundColor: '#FFF5F0', borderRadius: 12, borderWidth: 1, borderColor: '#0D9488' },
  uploadBtnText: { fontSize: 12, fontWeight: '600', color: '#0D9488', marginTop: 4 },
