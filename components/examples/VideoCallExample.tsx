...
export default function VideoCallExampleScreen() {
   ...
   * NotificationsContext automatically routes to /meet/[meetingId]/room
   * 
  ...
  const handleMeetingNotification = () => {
    ...
    // User taps notification → routes to /meet/[meetingId]/room
  };
    ...
    <Container>
      ...
      <View style={styles.exampleContainer}>
        ...
        <Button onPress={startVideoCallWithConfig}>
          <Ionicons name="videocam-off" size={20} color="#fff" style={styles.icon} />
      ...
      <View style={styles.exampleContainer}>
        <Text style={styles.exampleTitle}>Example 3: Join from Notification</Text>
        <Text style={styles.exampleDescription}>
      ...
      <View style={styles.exampleContainer}>
        <Text style={styles.exampleTitle}>Example 4: Meeting Notifications</Text>
        <Text style={styles.exampleDescription}>
          Display meeting-specific notifications with join buttons
        </Text>
        {getMeetingNotifications().slice(0, 3).map(notification => (
          <TouchableOpacity
            key={notification.id}
      ...
      <View style={styles.notesContainer}>
        ...
        <Text style={styles.noteItem}>
          POST /video/end - Notify call ended
        </Text>
        <Text style={styles.noteItem}>
          Body: {`{ duration }`}
        </Text>
