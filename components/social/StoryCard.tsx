      ...
      <View style={styles.createStoryImageContainer}>
        <Image
          source={{
            uri:
              user?.avatar ||
              "https://ui-avatars.com/api/?name=Story&size=100&background=FF6B35&color=fff",
          }}
...
// Single Story Card
const StoryCard = memo(function StoryCardComponent({
  story,
  onPress,
}: StoryCardProps) {
  const handlePress = useCallback(() => {
    ...
    >
      ...
      <View
        style={[
          ...
          !story.hasViewed && styles.storyAvatarUnviewed,
        ]}
      >
        <Image
          source={{
            uri:
              story.author.avatar ||
              "https://ui-avatars.com/api/?name=Author&size=32&background=4CAF50&color=fff",
          }}
      ...
      >
        <View
          style={[
            ...
            !item.hasViewed && styles.compactAvatarUnviewed,
          ]}
        >
          <Image
            source={{
              uri:
                item.author.avatar ||
                "https://ui-avatars.com/api/?name=Author&size=50&background=FF6B35&color=fff",
            }}
