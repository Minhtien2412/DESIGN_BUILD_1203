...
export const customerTopServiceItems: HomeIconItem[] = [
  {
...
export const customerDesignItems: HomeIconItem[] = [
  {
...
export const customerMarketplaceItems: HomeIconItem[] = [
