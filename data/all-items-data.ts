...
export const ALL_CONSTRUCTION_SERVICES: ListItem[] = [
  ...
  { id: 'villa', label: 'Tiến độ biệt thự', icon: 'home-outline', route: '/construction/villa-progress', color: '#666666' },
  ...
  { id: 'vat-lieu', label: 'Vật liệu', icon: '📦', route: '/utilities/vat-lieu', color: '#666666' },
...
export const ALL_FINISHING_SERVICES: ListItem[] = [
  ...
  { id: 'thach-cao', label: 'Thạch cao', icon: 'square-outline', route: '/finishing/thach-cao', color: '#666666', description: 'Trần thạch cao' },
  ...
  // Additional
  { id: 'noi-that', label: 'Nội thất', icon: 'bed-outline', route: '/finishing/noi-that', color: '#666666', description: 'Thiết kế nội thất' },
...
export const ALL_UTILITY_TOOLS: ListItem[] = [
  ...
  { id: 'quality', label: 'QC/QA', icon: 'checkmark-circle-outline', route: '/quality-assurance/index', color: '#666666', description: 'Kiểm soát chất lượng' },
  ...
  { id: 'analytics', label: 'Phân tích', icon: 'stats-chart-outline', route: '/utilities/analytics', color: '#666666', description: 'Phân tích dữ liệu' },
...
export const ALL_MAIN_SERVICES: ListItem[] = [
  ...
  { id: 'quote', label: 'Báo giá', icon: 'calculator-outline', route: '/utilities/quote-request', color: '#666666', description: 'Yêu cầu báo giá' },
