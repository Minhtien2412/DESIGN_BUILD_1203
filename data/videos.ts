...
const __generated: any = (() => {
  try {
    return require("./localVideos.generated");
  } catch {
    return {};
  }
})();
const GENERATED_VIDEOS: VideoItem[] = Array.isArray(
  __generated.GENERATED_VIDEOS,
)
  ? (__generated.GENERATED_VIDEOS as VideoItem[])
  : [];
...
export const DEMO_CONSTRUCTION_VIDEOS: VideoItem[] = [
  // === BIỆT THỰ & VILLA ===
  {
    ...
    type: "demo",
    description:
      "Video tiến độ xây dựng biệt thự hiện đại từ móng đến hoàn thiện",
    createdAt: "2025-12-01",
  },
  {
    id: "demo-villa-002",
    title: "Timelapse xây dựng Villa nghỉ dưỡng Đà Lạt",
    url: "https://videos.pexels.com/video-files/4012432/4012432-sd_640_360_25fps.mp4",
    thumbnail:
  ...
  // === THIẾT KẾ NỘI THẤT ===
  {
    ...
    url: "https://videos.pexels.com/video-files/5587894/5587894-sd_640_360_25fps.mp4",
    thumbnail:
  ...
  },
  {
    ...
    url: "https://videos.pexels.com/video-files/3129671/3129671-sd_640_360_24fps.mp4",
    thumbnail:
  ...
  // === KỸ THUẬT XÂY DỰNG ===
  {
    ...
    url: "https://videos.pexels.com/video-files/5765731/5765731-sd_640_360_25fps.mp4",
    thumbnail:
  ...
  },
  {
    ...
    url: "https://videos.pexels.com/video-files/3773486/3773486-sd_640_360_24fps.mp4",
    thumbnail:
  ...
  // === CẢNH QUAN & SÂN VƯỜN ===
  {
    ...
    url: "https://videos.pexels.com/video-files/5974163/5974163-sd_640_360_25fps.mp4",
    thumbnail:
  ...
  // === VẬT LIỆU XÂY DỰNG ===
  {
    ...
    url: "https://videos.pexels.com/video-files/7578542/7578542-sd_640_360_30fps.mp4",
    thumbnail:
  ...
  },
  {
    ...
    url: "https://videos.pexels.com/video-files/3251806/3251806-sd_640_360_25fps.mp4",
    thumbnail:
...
export function searchVideos(query: string): VideoItem[] {
  ...
  return ALL_LOCAL_VIDEOS.filter(
    (v) =>
