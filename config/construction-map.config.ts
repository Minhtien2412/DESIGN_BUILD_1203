 ...
 */
export function getConstructionMapConfig(env?: Environment): ConstructionMapConfig {
 ...
 */
export function getApiUrl(path: string, customConfig?: ConstructionMapConfig): string {
 ...
 */
export function isFeatureEnabled(feature: keyof ConstructionMapConfig['features']): boolean {
...
export const ERROR_MESSAGES = {
  CONNECTION_FAILED: 'Không thể kết nối đến server. Vui lòng kiểm tra internet.',
