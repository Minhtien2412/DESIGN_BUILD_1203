...
export const WEATHER_CONFIG = {
  ...
  openweathermap: {
    ...
    baseUrl: process.env.OPENWEATHERMAP_BASE_URL || 'https://api.openweathermap.org/data/2.5',
    units: 'metric',
    lang: 'vi',
  },
...
export function getConfiguredServices(): string[] {
  const allServices = [
    'openai', 'gemini', 'twilio', 'esms', 'openweathermap', 
    'weatherapi', 'newsapi', 'gnews', 'googlemaps', 'mapbox',
    'goong', 'vnpay', 'momo', 'zalopay', 'stripe', 'firebase',
...
export function getConfigSummary(): Record<string, boolean> {
  return {
    ...
    weather: isServiceConfigured('openweathermap') || isServiceConfigured('weatherapi'),
    news: isServiceConfigured('newsapi') || isServiceConfigured('gnews'),
    maps: isServiceConfigured('googlemaps') || isServiceConfigured('mapbox') || isServiceConfigured('goong'),
    payment: isServiceConfigured('vnpay') || isServiceConfigured('momo') || isServiceConfigured('zalopay') || isServiceConfigured('stripe'),
    storage: isServiceConfigured('cloudinary') || isServiceConfigured('firebase'),
