...
// Export methods for external use (like API client)
export const authActions = {
  ...
  clear: () => authStore.getState().clear(),
  hydrate: () => authStore.getState().hydrate(),
  setUser: (user: User) => authStore.getState().setUser(user),
};
